...
## Disponibilité des composants principaux de Forms adaptatif

Tous les environnements **AEM Forms as a Cloud Service** incluent une prise en charge native de la création de Forms adaptatif à l’aide des composants principaux. Pour obtenir des instructions détaillées sur la création d’un formulaire, reportez-vous à la section [Créer un formulaire adaptatif](/help/forms/create-an-adaptive-form.md).

### Activation des composants principaux de Forms adaptatif pour AEM 6.5
