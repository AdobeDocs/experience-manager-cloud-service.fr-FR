...
### Qui peut accéder aux fonctionnalités décrites dans Assets Insights dans AEM Assets Content Hub ?

Les utilisateurs d’AEM Assets Content Hub peuvent effectuer les actions et accéder aux fonctionnalités mentionnées dans la section Assets Insights .

### Quelles informations sur les ressources sont disponibles dans l’onglet Informations d’AEM Assets Content Hub ?

Vous pouvez afficher le nombre de ressources dans le référentiel, le nombre de collections, les chargements Assets par année, mois ou jour, les utilisateurs actifs par jour ou mois et la classification des ressources en fonction des formats de fichiers dans AEM Assets Content Hub.

### Comment puis-je afficher les statistiques des ressources chargées dans AEM Assets Content Hub ?

Vous pouvez afficher les statistiques des ressources et collections chargées dans AEM Assets Content Hub en accédant à l’onglet Insights , où vous pouvez suivre l’historique de chargement par année, mois ou jour.

### Quelles mesures puis-je analyser concernant l’activité des utilisateurs dans AEM Assets Content Hub ?

Vous pouvez analyser le nombre d’utilisateurs et d’utilisatrices actifs par jour ou par mois, ce qui est représenté visuellement à l’aide d’un graphique linéaire dans AEM Assets Content Hub.
