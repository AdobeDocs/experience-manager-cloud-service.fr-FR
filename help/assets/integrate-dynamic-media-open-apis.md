...
Vous pouvez intégrer votre propre interface utilisateur personnalisée au référentiel Experience Manager Assets à l’aide des API Search and Delivery ou utiliser la fonction de conseil sur le contenu d’Adobe.
...
Le gestionnaire d’accès fournit une interface utilisateur qui s’intègre facilement au référentiel [!DNL Experience Manager Assets as a Cloud Service]. Vous pouvez ainsi parcourir ou rechercher des ressources numériques approuvées disponibles dans le référentiel et les utiliser dans votre expérience de création d’applications. Pour plus d&#39;informations, voir [Gestionnaire d&#39;accès](/help/assets/integrate-adobe-non-adobe-applications.md).
