...
Cette fonction d’écriture différée XMP dans les ressources Adobe Experience Manager (AEM) permet de répliquer les modifications apportées aux métadonnées des fichiers aux rendus de la ressource.
