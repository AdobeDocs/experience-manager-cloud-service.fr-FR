...
## Options contextuelles {#context-options}

Lors de lՎdition sur place, lՎditeur propose des options contextuelles avec un clic droit, telles que la duplication, la suppression ou la copie de composants.

![Menu Options contextuelles](assets/context-options-menu.png)
