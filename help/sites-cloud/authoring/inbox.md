...
>[!NOTE]
>
>Certaines opérations sont également répertoriées en [mode Carte de la ressource appropriée](/help/sites-cloud/authoring/basic-handling.md#card-view).
...
>[!NOTE]
>
>La boîte de réception fonctionne comme une console. Vous pouvez ainsi utiliser la [navigation globale](/help/sites-cloud/authoring/basic-handling.md#global-navigation) ou la fonction de [recherche](/help/sites-cloud/authoring/search.md) pour accéder à un autre emplacement lorsque vous avez terminé.
