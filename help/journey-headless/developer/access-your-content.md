...
**Référence du fragment** et **UUID de référence du fragment** :

* constituent des types de données spécifiques disponibles lors de la définition d’un modèle de fragment de contenu ;
...
Les requêtes peuvent être saisies dans l’interface GraphiQL. Vous pouvez accéder au requêteur à partir de :
