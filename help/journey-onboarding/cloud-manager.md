...
Dans cette partie du [parcours d’intégration](overview.md), vous allez apprendre à accéder à Cloud Manager afin de pouvoir configurer les ressources de votre projet.
