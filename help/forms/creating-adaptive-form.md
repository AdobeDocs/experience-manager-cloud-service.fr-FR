---
title: 'Créateur de formulaires : créez des formulaires avec des composants de base'
description: Découvrez comment utiliser le créateur de formulaires d’AEM Forms pour créer des formulaires adaptatifs avec des composants de base. Parfait pour les créateurs de formulaires qui gèrent des formulaires existants ou utilisent des intégrations héritées.
keywords: créateur de formulaires, composants de base, créer des formulaires, créateur de formulaires, formulaires adaptatifs, créer des formulaires, AEM forms, créateur de formulaires
...
# Créateur de formulaires : créez des formulaires avec des composants de base {#creating-an-adaptive-form}
