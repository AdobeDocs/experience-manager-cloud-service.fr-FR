...
* **Titre**
   ...
   * L’icône d’information (i) permet d’accéder rapidement à des options de configuration et d’informations supplémentaires spécifiques au fragment dans le panneau de droite.
* **Nom**
...
* **[Prévisualisation](/help/sites-cloud/administering/content-fragments/visual-content-fragments.md#preview-your-fragment-with-a-template)**
* **Déplacer**
* **Renommer**
...
* **Dépublié** (rouge)
Le fragment de contenu a été dépublié.
...
Lorsque cette option est sélectionnée, les fragments référencés sont copiés au même emplacement que le fragment sélectionné d’origine.
      ...
      * **Copier dans leurs emplacements d’origine**
