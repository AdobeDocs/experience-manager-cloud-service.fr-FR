...
![Recherche de fichiers dans la vue du référentiel](../assets/guides/repository-filter-search-2404.png)
...
![Boîte de dialogue Insérer un extrait de contenu](../assets/guides/insert-content-snippet.png)
