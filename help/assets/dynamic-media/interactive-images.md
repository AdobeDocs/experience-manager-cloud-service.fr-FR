...
* Dans Firefox, vous pouvez activer le plug-in Firebug en appuyant sur F12 et en utilisant son onglet Net. Vous pouvez également utiliser l’outil Inspecteur intégré et son onglet Réseau.Sur Mac, appuyez sur Commande+Option+I pour ouvrir le panneau Outils de développement, puis sélectionnez l’onglet Inspecteur.
...
1. Publiez l’image interactive. La publication fournit la bannière via le cloud et génère également un code intégré qui vous permet de l’intégrer à un autre site web.
...
Lorsque vous chargez une image de bannière, que vous ajoutez des zones réactives à l’image et que vous publiez l’image interactive, vous pouvez l’ajouter à une page de votre site web.
...
1. Copiez le code intégré de l’image interactive publiée.Consultez [Incorporation de la visionneuse de vidéos ou d’images dans une page web](/help/assets/dynamic-media/embed-code.md).
...
>[!NOTE]
>
>À ce stade, les zones réactives de l’image interactive Shoppable du site web de démonstration sont en mode affichage uniquement. Ils ne sont pas encore intégrés aux aperçus rapides existants.
