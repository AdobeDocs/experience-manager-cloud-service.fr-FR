...
* Le service Preview est déployé de manière progressive dans tous les programmes. Les clients sont avertis dans le produit lorsque leur programme est activé pour le service de prévisualisation. Voir [Accès au service de prévisualisation](/help/implementing/cloud-manager/manage-environments.md#access-preview-service) pour plus d’informations.
