...
+ Notes de mise à jour {#release-notes}
   ...
   + Notes de mise à jour des fonctionnalités d’AEMaaCS {#release-notes}
      ...
      + 2025 {#2025}
         ...
         + [Notes de mise à jour de la version 2025.8.0](/help/release-notes/release-notes-cloud/2025/release-notes-2025-8-0.md)
   ...
   + Notes de mise à jour de la maintenance d’AEMaaCS {#maintenance}
      ...
      + 2025 {#2025}
         ...
         + [Notes de mise à jour de la maintenance 2025.10.0](/help/release-notes/maintenance/2025/2025-10-0.md)
   ...
   + Notes de mise à jour de l’éditeur universel {#universal-editor}
      ...
      + 2026 {#2026}
         + [Notes De Mise À Jour 2026.07.09](/help/release-notes/universal-editor/2026/2026-07-09.md)
         + [Notes De Mise À Jour 2026.07.02](/help/release-notes/universal-editor/2026/2026-07-02.md)
         + [Notes De Mise À Jour 2026.06.25](/help/release-notes/universal-editor/2026/2026-06-25.md)
         ...
         + [Notes De Mise À Jour 2026.05.21](/help/release-notes/universal-editor/2026/2026-05-21.md)
         + [Notes De Mise À Jour 2026.05.14](/help/release-notes/universal-editor/2026/2026-05-14.md)
         + [Notes De Mise À Jour 2026.05.07](/help/release-notes/universal-editor/2026/2026-05-07.md)
         + [Notes De Mise À Jour 2026.04.30](/help/release-notes/universal-editor/2026/2026-04-30.md)
      ...
      + 2025 {#2025}
         ...
         + [Notes de mise à jour de la version 2025.12.04](/help/release-notes/universal-editor/2025/2025-12-04.md)
         + [Notes de mise à jour de la version 2025.11.20](/help/release-notes/universal-editor/2025/2025-11-20.md)
         + [Notes de mise à jour de la version 2025.11.13](/help/release-notes/universal-editor/2025/2025-11-13.md)
         + [Notes de mise à jour de la version 2025.11.06](/help/release-notes/universal-editor/2025/2025-11-06.md)
         + [Notes de mise à jour de la version 2025.10.30](/help/release-notes/universal-editor/2025/2025-10-30.md)
         + [Notes de mise à jour de la version 2025.10.24](/help/release-notes/universal-editor/2025/2025-10-24.md)
         + [Notes de mise à jour de la version 2025.10.16](/help/release-notes/universal-editor/2025/2025-10-16.md)
         + [Notes de mise à jour de la version 2025.10.09](/help/release-notes/universal-editor/2025/2025-10-09.md)
         + [Notes de mise à jour de la version 2025.10.02](/help/release-notes/universal-editor/2025/2025-10-02.md)
         + [Notes de mise à jour de la version 2025.09.25](/help/release-notes/universal-editor/2025/2025-09-25.md)
...
+ Sécurité {#security}
   ...
   + [Test de connectivité réseau](/help/security/network-connectivity-test.md)
   + [Prise en charge IMS d’AEM as a Cloud Service](/help/security/ims-support.md)
   + {hide-from-toc}[Modifications dans la synchronisation des groupes d’utilisateurs et des profils de produits](/help/security/changes-in-user-group-and-product-profile-synchronization.md)
   + [Migration vers une identité externe et l’appartenance à un groupe dynamique](/help/security/migrating-to-external-identity.md)
   ...
   + {hide-from-toc}[Considérations relatives à la sécurité d’](/help/security/security-considerations.md)
   ...
   + [Intégrations d’API gérées par Adobe dans Adobe Admin Console](/help/security/adobe-managed-api-integrations-in-adobe-admin-console.md)
...
+ Essais AEMaaCS {#trials}
   + Essais découplés {#headless}
      + {hide-from-toc}[Personnaliser du contenu dans un exemple d’application React](/help/trials/headless/customize-app.md)
      + {hide-from-toc}[Créer la structure de contenu pour votre application](/help/trials/headless/content-structure.md)
      + {hide-from-toc}[Créer du contenu découplé](/help/trials/headless/create-content.md)
      + {hide-from-toc}[Extraction de contenu via l’API GraphQL](/help/trials/headless/extract-content.md)
      + {hide-from-toc}[Récupérer du contenu JSON avec JavaScript](/help/trials/headless/code-playground.md)
      + {hide-from-toc}[Modification en ligne avec l’éditeur universel](/help/trials/headless/universal-editor.md)
+ Parcours de migration d’AEM as a Cloud Service {#migration-journey}
   ...
   + Outils de transition vers le cloud {#cloud-migration}
      ...
      + Outil de transfert de contenu {#content-transfer-tool}
         ...
         + {hide-from-toc}[Migration de groupes d’utilisateurs fermés](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/closed-user-groups-migration.md)
         ...
         + Outil de mappage hérité (hérité){#legacy-user-mapping-tool}
            + {hide-from-toc}[Vue d’ensemble](/help/journey-migration/content-transfer-tool/user-mapping-tool-legacy/overview-user-mapping-tool-legacy.md)
            + {hide-from-toc}[Points importants](/help/journey-migration/content-transfer-tool/user-mapping-tool-legacy/considerations-user-mapping-tool-legacy.md)
            + {hide-from-toc}[Utilisation de l’outil de mappage des utilisateurs](/help/journey-migration/content-transfer-tool/user-mapping-tool-legacy/using-user-mapping-tool-legacy.md)
   + Migration de code assistée par l’IA {#cloud-migration-skill}
      + [Vue d’ensemble](/help/journey-migration/cloud-migration-skill/overview-cloud-migration-skill.md)
      + [Utilisation des compétences de migration vers le cloud](/help/journey-migration/cloud-migration-skill/using-cloud-migration-skill.md)
      + [Utilisation du MCP de migration vers le cloud](/help/journey-migration/cloud-migration-skill/using-cloud-migration-mcp.md)
...
+ Sites {#sites}
   ...
   + Administration {#administering}
      + Fragments de contenu {#content-fragments}
         + [Concepts et bonnes pratiques](/help/sites-cloud/administering/content-fragments/overview.md)
         ...
         + [Aperçu des fragments](/help/sites-cloud/administering/content-fragments/preview.md)
         + [Fragments de contenu visuels](/help/sites-cloud/administering/content-fragments/visual-content-fragments.md)
         + {hide-from-toc}[Réutilisation de fragments de contenu à l’aide de MSM](/help/sites-cloud/administering/content-fragments/msm-for-content-fragments.md)
...
+ Ressources {#assets}
   ...
   + {hide-from-toc}[Résolution des problèmes d’AEM Assets](/help/assets/troubleshoot-aem-assets.md)
   ...
   + Gestion des ressources numériques {#manage}
      ...
      + {hide-from-toc}[Surveiller les activités et les tâches de gestion des ressources numériques](/help/assets/assets-activity-history.md)
      ...
      + [Entraînement des balises intelligentes](/help/assets/smart-tags-training.md)
      ...
      + {hide-from-toc}[Rapport d’activation d’AEM Assets (Beta)](/help/assets/aem-assets-activation-report.md)
   ...
   + Conseiller ou conseillère en contenu {#content-advisor}
      ...
      + [Intégration à Dynamic Media](/help/assets/integration-with-dynamic-media.md)
      + [Intégration de Dynamic Media aux fonctionnalités OpenAPI](/help/assets/integrate-dynamic-media-openapi.md)
   + Fragments de contenu {#content-fragments}
      ...
      + [Activation de la fonctionnalité de fragment de contenu pour votre instance](/help/assets/content-fragments/content-fragments-configuration-browser.md)
   ...
   + Dynamic Media {#dynamicmedia}
      + Parcours Dynamic Media : principes de base {#dm-journey}
         ...
         + [Deuxième partie : anatomie d’une URL Dynamic Media - Principes fondamentaux des paramètres d’image prédéfinis - À propos des ensembles d’images, des visionneuses à 360° et des visionneuses de supports variés](/help/assets/dynamic-media/dm-journey-part2.md)
      ...
      + {hide-from-toc}[Facultatif - Configuration de Dynamic Media, paramètres généraux](/help/assets/dynamic-media/dm-general-settings.md)
      + {hide-from-toc}[Facultatif - Configuration de Dynamic Media et configuration de la publication](/help/assets/dynamic-media/dm-publish-settings.md)
      + [Résolution des problèmes liés à Dynamic Media](/help/assets/dynamic-media/troubleshoot-dm.md)
      + {hide-from-toc}[Configuration d’un compte d’alias Dynamic Media](/help/assets/dynamic-media/dm-alias-account.md)
      ...
      + [Gestion des paramètres d’image prédéfinis Dynamic Media](/help/assets/dynamic-media/managing-image-presets.md)
      + [Application de paramètres d’image prédéfinis Dynamic Media](/help/assets/dynamic-media/image-presets.md)
      ...
      + [Nouvelle visionneuse de vidéos](/help/assets/dynamic-media/new-video-viewer.md)
      ...
      + {hide-from-toc}[Demander un rapport d&#39;erreur pour les URL de diffusion ayant échoué](/help/assets/dynamic-media/reporting-dm.md)
      ...
      + Dynamic Media avec fonctionnalités OpenAPI {#dynamic-media-open-apis}
         ...
         + [Recadrage intelligent de vidéo](/help/assets/video-smart-crops.md)
   ...
   + Utilisation de la vue Ressources {#assets-view}
      ...
      + [Métadonnées générées par l’IA](/help/assets/ai-generated-metadata-assets-view.md)
      + [Modifier les images](/help/assets/edit-images-assets-view.md)
      ...
      + [Vue Assets des métadonnées en cascade](/help/assets/cascading-metadata-assets-view.md)
...
+ Formulaires {#forms}
   ...
   + Configuration et migration {#setup-configure-migrate}
      ...
      + {hide-from-toc}[Activer les composants principaux de Forms adaptatif sur AEM Forms as a Cloud Service et l’environnement de développement local](/help/forms/enable-adaptive-forms-core-components.md)
   ...
   + Prise en main {#getting-started-forms}
      + {hide-from-toc}[Cas d’utilisation et configuration de l’environnement de développement](/help/forms/create-adaptive-form-tutorial-getting-started.md)
      + {hide-from-toc}[Créer le formulaire de demande de prêt](/help/forms/create-adaptive-form-tutorial.md)
   + Intégration {#integrate}
      ...
      + Modèle de données de formulaire {#use-form-data-model}
         ...
         + {hide-from-toc}[Conception d’un schéma XML pour un formulaire adaptatif](/help/forms/adaptive-form-xml-schema-form-model.md)
   ...
   + Formulaires adaptatifs {#adaptive-forms-authoring}
      + {hide-from-toc}[Créer un formulaire adaptatif](/help/forms/create-an-adaptive-form.md)
      + {hide-from-toc}[Quels formulaires adaptatifs sont les mieux adaptés à vos besoins ?](/help/edge/docs/forms/authoring-a-form.md)
      ...
      + [Gestion des versions d’Assets de formulaire dans Forms Manager](/help/forms/manage-form-versions-forms-manager.md)
      + Composants principaux {#authoring-adaptive-forms-core-components}
         + Créer un formulaire adaptatif {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Personnalisation des thèmes de formulaire adaptatif à l’aide de l’éditeur de thèmes](/help/forms/customizing-themes-using-theme-editor.md)
            ...
            + [Générer un PDF d’envoi (anciennement Document d’enregistrement) pour le Forms adaptatif](/help/forms/generate-document-of-record-core-components.md)
            + [Personnaliser le modèle de document d’enregistrement généré automatiquement](/help/forms/customize-document-of-record-template.md)
            + [Balises de balisage HTML prises en charge dans Submission PDF](/help/forms/html-markup-tags-support-in-document-of-record.md)
            ...
            + {hide-from-toc}[Convertir un Forms adaptatif basé sur des composants de base en formulaires basés sur les composants principaux à l’aide de l’utilitaire de migration](/help/forms/migration-utility-tool-for-af-core-components.md)
            + {hide-from-toc}[Modèles d’e-mail dans le Forms adaptatif](/help/forms/html-email-templates-in-adaptive-forms.md)
      ...
      + Composants de base {#authoring-adaptive-forms-foundation-components}
         ...
         + Créer un formulaire adaptatif {#create-an-adaptive-form-on-forms-cs}
            ...
            + {hide-from-toc}[Créer une aide contextuelle pour les champs de formulaire](/help/forms/authoring-in-field-help.md)
            ...
            + {hide-from-toc}[Fragments de formulaire adaptatif de référence](/help/forms/reference-adaptive-form-fragments.md)
            + {hide-from-toc}[Synchronisation de Forms adaptatif avec des modèles de formulaire XFA](/help/forms/synchronizing-adaptive-forms-xfa.md)
            + {hide-from-toc}[Prise en charge de XFA dans le Forms adaptatif basé sur XDP](/help/forms/xfa-api-supported-in-adaptive-form.md)
         ...
         + Configuration des actions Envoyer et de l’envoi de métadonnées {#configure-submit-actions-and-metadata-submission}
            ...
            + {hide-from-toc}[Ajouter des informations issues de données utilisateur aux métadonnées d’envoi de formulaire](/help/forms/form-submission-metadata.md)
            + {hide-from-toc}[API pour appeler le service de modèle de données de formulaire (FDM) depuis le Forms adaptatif](/help/forms/invoke-form-data-model-services.md)
         + [Préremplissage des champs de formulaires adaptatifs](/help/forms/prepopulate-adaptive-form-fields.md)
         + [Générer un PDF d’envoi (anciennement Document d’enregistrement)](/help/forms/generate-document-of-record-for-non-xfa-based-adaptive-forms.md)
         ...
         + {hide-from-toc}[Associer des réviseurs d’envoi à un formulaire](/help/forms/adding-reviewers-form.md)
         + {hide-from-toc}[Créer et gérer des révisions pour un formulaire adaptatif](/help/forms/review-adaptiveforms-in-sites-page.md)
   ...
   + Formulaires HTML5 {#html5-forms}
      ...
      + {hide-from-toc}[Architecture d’HTML5 forms](/help/forms/html5-forms-architecture.md)
      ...
      + {hide-from-toc}[Enregistrer un formulaire HTML5 en tant que brouillon](/help/forms/saving-html5-form-draft.md)
      ...
      + {hide-from-toc}[Jeu de formulaires dans AEM Forms](/help/forms/formset-in-aem-forms.md)
+ Communication interactive {#interactive-communication}
   + Comprendre la communication interactive {#overview}
      + [Présentation](/help/forms/interactive-communication/introduction.md)
      + [Prise en main](/help/forms/interactive-communication/getting-started.md)
   ...
   + Composant {#component}
      ...
      + [Champ d’image](/help/forms/interactive-communication/image-field.md)
      + [Champ de texte](/help/forms/interactive-communication/text-field.md)
      + [Champ numérique](/help/forms/interactive-communication/numeric-field.md)
      + [Champ Date/Heure](/help/forms/interactive-communication/date-time-field.md)
      + [Champ de date](/help/forms/interactive-communication/date-field.md)
      + [Case à cocher](/help/forms/interactive-communication/check-box.md)
      + [Bouton radio](/help/forms/interactive-communication/radio-button.md)
      + [Sous-formulaire](/help/forms/interactive-communication/subform.md)
      + [Rectangle](/help/forms/interactive-communication/rectangle.md)
      + [Tableau](/help/forms/interactive-communication//table.md)
      + [Ligne](/help/forms/interactive-communication/line.md)
      + [Code-barres](/help/forms/interactive-communication/barcode.md)
      + [Variable non liée](/help/forms/interactive-communication/unbound-variable.md)
   + Procédures {#howto}
      + [Configurer la liaison de données](/help/forms/interactive-communication/configure-data-binding.md)
      + [Utilisation de l’éditeur de règles](/help/forms/interactive-communication/use-the-rule-editor.md)
      + [Importer et exporter la communication interactive](/help/forms/interactive-communication/import-and-export-the-interactive-communication.md)
      + [Ajouter des polices personnalisées](/help/forms/interactive-communication/add-custom-fonts.md)
      + [Générer l’aperçu PDF](/help/forms/interactive-communication/generate-pdf-preview.md)
      + [Activer le verrouillage de modèle](/help/forms/interactive-communication/enable-template-lock.md)
      + [Implémentation de la numérotation dynamique de page](/help/forms/interactive-communication/implement-dynamic-page-numbering.md)
      + [Gérer le dépassement de contenu](/help/forms/interactive-communication/handle-content-overflow.md)
      + [Prise en charge de l’édition XDP](/help/forms/interactive-communication/support-xdp-editing.md)
...
+ Workflows basés sur Forms {#create-form-centric-workflows}
   ...
   + {hide-from-toc}[Sélection dynamique d’utilisateurs, d’utilisatrices ou de groupes dans un workflow AEM](/help/forms/dynamically-select-a-user-or-group-for-aem-workflow.md)
   + {hide-from-toc}[Gestion des applications et des tâches Forms dans la boîte de réception AEM](/help/forms/manage-applications-inbox.md)
...
+ API Communications {#using-communications}
   ...
   + [API AEM Forms Communications](/help/forms/aem-forms-communication-api-overview.md)
   ...
   + Tableau de bord de réalisation de valeurs  {#vr-dashboard}
      + {hide-from-toc}[Présentation du tableau de bord de réalisation de la valeur](/help/forms/aem-forms-value-realization-dashboard.md)
      + {hide-from-toc}[Utilisation du tableau de bord de réalisation des valeurs pour analyser les tendances d’utilisation des formulaires et documents](/help/forms/using-the-value-realization-dashboard.md)
...
+ IA dans AEM {#ai-in-aem}
   ...
   + Prise en charge de MCP {#mcp-support}
      + [Utilisation de MCP avec AEM as a Cloud Service](/help/ai-in-aem/mcp-support/using-mcp-with-aem-as-a-cloud-service.md)
      + Applications De Chat (Web Et Bureau) {#chat-applications}
         + [Configuration d’Anthropic Claude avec AEM MCP](/help/ai-in-aem/mcp-support/setup-claude.md)
         + [Configuration de OpenAI ChatGPT avec AEM MCP](/help/ai-in-aem/mcp-support/setup-chatgpt.md)
      + Outils de développement (extensions IDE, applications de bureau, interfaces de ligne de commande) {#developer-tools}
         + [Configuration du curseur avec AEM MCP](/help/ai-in-aem/mcp-support/setup-cursor.md)
   ...
   + Agents dans AEM {#agents}
      ...
      + Brand Experience Agent {#brand-experience}
         + [Vue d’ensemble](/help/ai-in-aem/agents/brand-experience/overview.md)
         + Agent de production d’expérience {#experience-production}
            ...
            + [Tâche de conversion de format en fragments de contenu visuels](/help/ai-in-aem/agents/brand-experience/experience-production/figma-to-visual-content-fragments.md)
         ...
         + Agent de modernisation de l’expérience {#modernization}
            + [Vue d’ensemble](/help/ai-in-aem/agents/brand-experience/modernization/overview.md)
            + [Prise en main](/help/ai-in-aem/agents/brand-experience/modernization/getting-started.md)
            + [Prise en main des projets de création AEM](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md)
            + [Console de modernisation](/help/ai-in-aem/agents/brand-experience/modernization/console.md)
            + [Guide de l’invite](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md)
            + [Compétence en documentation de projet](/help/ai-in-aem/agents/brand-experience/modernization/project-documentation.md)
            + [Compétence du catalogue de sites](/help/ai-in-aem/agents/brand-experience/modernization/site-catalog.md)
            + [Diffusion AOE](/help/ai-in-aem/agents/brand-experience/modernization/aoe-delivery.md)
         + [Agent de développement](/help/ai-in-aem/agents/brand-experience/development/development.md)
      + Agent du gestionnaire de contenu {#content-advisor}
         + [Vue d’ensemble](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [Agent de découverte de contenu](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [Agent d’optimisation de contenu](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
      + Agent de gouvernance de marque {#governance}
         + [Vue d’ensemble](/help/ai-in-aem/agents/governance/overview.md)
         + [Comment importer une politique de marque](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md)
   ...
   + Créateur d’expériences de formulaires {#forms-experience-builder}
      + {hide-from-toc}[Forms Experience Builder - Aperçu](/help/forms/experience-builder/product-overview.md)
      + {hide-from-toc}[Prise en main de Forms Experience Builder](/help/forms/experience-builder/forms-experience-builder-getting-started.md)
      + {hide-from-toc}[Déploiement et configuration de Forms Experience Builder](/help/forms/experience-builder/deploy-forms-experience-builder.md)
      + Procédures {#forms-experience-builder-how-to}
         + {hide-from-toc}[Comment convertir une image en formulaire ?](/help/forms/experience-builder/intelligent-import-conversion.md)
         + {hide-from-toc}[Comment configurer les envois et les intégrations de formulaires ?](/help/forms/experience-builder/form-submission-integration.md)
         + {hide-from-toc}[Comment créer des champs intelligents optimisés pour LLM dans Forms Experience Builder ?](/help/forms/experience-builder/forms-experience-builder-llm-smart-fields.md)
         + {hide-from-toc}[Comment démarrer une nouvelle conversation de thread dans Forms Experience Builder ?](/help/forms/experience-builder/configure-forms-experience-builder-ui-options.md)
      + {hide-from-toc}[Bibliothèque d’invites](/help/forms/experience-builder/forms-experience-builder-prompt-examples-library.md)
      + {hide-from-toc}[Questions fréquentes)](/help/forms/experience-builder/forms-experience-builder-frequently-asked-questions.md)
...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Créer des formulaires {#build-forms}
      ...
      + Création WYSIWYG {#universal-editor}
         ...
         + {hide-from-toc}[Créer un objet de lead Salesforce à l’aide de l’intégration d’API](/help/edge/docs/forms/universal-editor/create-lead-object-using-api-integration.md)
         + Liste déroulante en cascade {#cascading-drop-down-list}
            ...
            + [Créer un formulaire](/help/edge/docs/forms/cascading-drop-down-list/create-form.md)
      + Création basée sur des documents {#getting-started-edge-delivery-services-forms}
         ...
         + {hide-from-toc}[Validation de champ de formulaire : ajoutez des contrôles d’erreur à votre Forms](/help/edge/docs/forms/validate-forms.md)
         ...
         + {hide-from-toc}[Validation avancée de formulaire : guide d’expression régulière](/help/edge/docs/forms/regex-forms.md)
         + {hide-from-toc}[Créer un Forms réutilisable : guide des fragments de formulaire](/help/edge/docs/forms/form-fragments.md)
         + [Créer des formulaires dynamiques : ajouter des sections répétables](/help/edge/docs/forms/repeatable-forms.md)
         + {hide-from-toc}[Rendre votre formulaire global : Guide de traduction de formulaire](/help/edge/docs/forms/translate-forms.md)
         + [Protéger vos formulaires : ajouter une sécurité reCAPTCHA](/help/edge/docs/forms/recaptacha-forms.md)
         + {hide-from-toc}[Créer des composants de formulaire personnalisés : guide du développeur](/help/edge/docs/forms/custom-components-forms.md)
         + {hide-from-toc}[Surveillance des performances du formulaire : guides de télémétrie opérationnelle](/help/edge/docs/forms/operational-telemetry-for-forms.md)
      ...
      + {hide-from-toc}[Questions fréquentes](/help/edge/docs/forms/adapttive-forms-for-edge-delivery-services-faq.md)
   + {hide-from-toc}[Bonnes pratiques relatives à la création de formulaires](/help/edge/docs/forms/universal-editor/best-practices-eds-forms.md)
+ Découplé {#headless}
   ...
   + Sélecteur de fragment de contenu {#content-fragment-selector}
      ...
      + [Intégration à une application Adobe](/help/headless/content-fragment-selector/integrate-adobe-application.md)
      + [Intégration à une application non Adobe ou tierce](/help/headless/content-fragment-selector/integrate-non-adobe-application.md)
      + [Intégrer le sélecteur de fragment de contenu à l’aide de Vanilla JS](/help/headless/content-fragment-selector/integrate-using-vanilla-js.md)
...
+ Implémentation {#implementing}
   ...
   + Utiliser Cloud Manager {#using-cloud-manager}
      ...
      + [Environnements de test spécialisés](/help/implementing/cloud-manager/specialized-test-environment.md)
      + Gestion du code {#managing-code}
         ...
         + [Ajouter un référentiel externe](/help/implementing/cloud-manager/managing-code/external-repositories.md)
         + [Gérer les jetons d’accès des référentiels externes](/help/implementing/cloud-manager/managing-code/manage-access-tokens.md)
      ...
      + Pipelines CI-CD Cloud Manager {#cicd-pipelines}
         ...
         + [Fractionner le pipeline d’évaluation et de production uniquement](/help/implementing/cloud-manager/configuring-pipelines/stage-prod-only.md)
      ...
      + Rapports {#reports}
         ...
         + {hide-from-toc}[Comparaison visuelle](/help/implementing/cloud-manager/reports/report-visual-comparison.md)
         + [Évaluation de l’intégrité](/help/implementing/cloud-manager/reports/report-health-assessment.md)
         + [Audit d’expérience](/help/implementing/cloud-manager/reports/report-experience-audit.md)
   ...
   + Développement pour AEM as a Cloud Service {#developing}
      ...
      + [Fonctions d’AEM Edge](/help/implementing/developing/introduction/edge-functions.md)
      + [Mise en cache des fonctions AEM Edge](/help/implementing/developing/introduction/edge-functions-caching.md)
      ...
      + Éditeur universel {#universal-editor}
         ...
         + [Événements](/help/implementing/universal-editor/events-universal-editor.md)
         + [Filtres](/help/implementing/universal-editor/filtering.md)
         + [Configuration de l’éditeur de texte enrichi](/help/implementing/universal-editor/configure-rte.md)
         + [Configuration du sélecteur Assets](/help/implementing/universal-editor/configure-assets-selector.md)
   ...
   + Vue d’ensemble de la diffusion de contenu {#content-delivery}
      ...
      + {hide-from-toc}[Validation et débogage à l’aide de l’héritage des outils Dispatcher](/help/implementing/dispatcher/validation-debug-legacy.md)
...
+ Opérations {#operations}
   ...
   + [Workflows de réplication d’arborescence](/help/operations/tree-replication-workflows.md)
   ...
   + [Restaurer Le Code Précédent Déployé](/help/operations/restore-previous-code-deployed.md)
...
+ Compliance {#compliance}
   ...
   + HIPAA {#hipaa}
      + [Préparation du HIPAA](/help/compliance/hipaa/hipaa-readiness.md)
...
+ Résolution des problèmes {#troubleshooting}
   + {hide-from-toc}[Résolution des problèmes AEM Assets et Forms](/help/troubleshooting/home.md)
