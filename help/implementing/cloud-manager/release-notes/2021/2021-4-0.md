...
* Lorsqu’un utilisateur ajoute un nouvel environnement, il est informé qu’une fois un environnement créé, il ne peut plus être déplacé vers une autre région.
