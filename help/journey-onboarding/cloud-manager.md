...
En vous connectant en tant qu’administrateur ou administratrice système avec le rôle de **Propriétaire de l’entreprise**, vous initialisez Cloud Manager pour une utilisation par les autres personnes affectées au rôle de **Propriétaire de l’entreprise**. Vous ne recevez aucune confirmation ni aucun message. Il vous suffit de vous connecter.
