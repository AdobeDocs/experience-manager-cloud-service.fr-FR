...
| `notify` | Cette action envoie un événement de page que la page a déployé. Pour être averti, un utilisateur doit d’abord s’abonner aux événements de déploiement. |  |
