...
- ASSETS-19544 : la propriété Dernière modification par Assets est désormais définie sur l’utilisateur demandant le traitement.

### Problèmes résolus {#fixed-issues-13420}

- ASSETS-27628 : création d’un nœud « channels » erroné lors de la personnalisation du panneau de recherche Assets.
- ASSETS-27539 : restrictions de chargement et correspondance d’expressions régulières.
- ASSETS-26530 : Unified Shell ne ramène pas les utilisateurs à la page d’origine.
- ASSETS-22719 : les crochets dans l’affectation de nom au point d’arrêt de recadrage intelligent rompent la fonction de modification de recadrage intelligent.
...
- ASSETS-25544 : correction du bouton d’invalidation du cache du réseau CDN désactivé.
- ASSETS-26575 : correction de la troncation du nom lors de la création de visionneuses d’images.
- ASSETS-26705 : correction d’un traitement inutile sur les ressources de dossier et les fragments de contenu non DM.
- ASSETS-25740 : les lecteurs d’écran fixes ne narrent pas le nom et le rôle des contrôles Modifier/Recadrer sur la page « Modifier les recadrages intelligents » à l’aide des touches fléchées vers le bas.
- CQ-4354266 : impossible d’ouvrir les éléments de boîte de réception.
- CQ-4354347 : Mise à jour des traductions AEM.
- DISP-1009 : User-Agent comme non-first header trims X-Forwarded-Host.
...
- ASSETS-26713 : lien externe de l’interface utilisateur tactile vers le nouveau tableau de bord de l’interface utilisateur d’Experience Platform - intégration unifiée en shell et mise à niveau optimisée pour l’interface utilisateur tactile.
- SKYOPS-63302 : mise à niveau de com.adobe.granite:com.adobe.granite.auth.saml vers la version 1.0.54.
- GRANITE-46634 : mise à niveau vers la version 1.4.0 du client d’événement.
...
- GRANITE-46631 : mettez à jour Jackrabbit version vers 2.20.11.
- SKYOPS-61895 : mise à jour vers Jackrabbit Filevault 3.7.0.

### Problèmes résolus {#fixed-issues-13323}

- ASSETS-28461 : la visionneuse cloud de documents ne fonctionne pas pour les PDF, correction apportée par 13239.
- SKYOPS-63290 : correction d’une évolution incorrecte des compartiments.
- SKYOPS-54607 : calcul de la charge du serveur Ratelimiter incorrect pour une demande ayant échoué.
- ASSETS-27648 : ContentModelIT ne parvient pas à lire les fichiers d’exclusion des autres lots.
- GRANITE-43744 : l’authentificateur Sling ne fonctionne pas correctement en cas de configuration incorrecte avec le chemin d’accès authentication-requirement et vanity.
- GRANITE-46419 : problème d’intégration d’AEM à l’Idp Auth0.
- GRANITE-46292 : la configuration SAML d’Okta ne fonctionne pas après la mise à jour d’AEM Cloud.
...
- FORMS-10652 : les variables ne sont pas renseignées dans le menu déroulant de sélection de variable. L’utilisateur ne peut donc pas mapper de variables dans une étape de workflow.
- CQ-4353233 : lorsque vous réessayez un workflow et que l’opération échoue, un message d’erreur incorrect s’affiche.
