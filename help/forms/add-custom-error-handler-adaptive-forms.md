...
* **`Response:`**
      ...
      &quot;dataRef&quot;: &quot;&quot;,
      &quot;details&quot;: [
      &quot;ID non valide fourni. La valeur fournie n’est pas correcte !&quot;
      ]
      }
      ]}
      &quot;
  ...
  ![Expression Som d’un champ de formulaire adaptatif pour afficher la réponse d’erreur dans le gestionnaire d’erreurs personnalisé](/help/forms/assets/custom-error-handler-somexpression.png)
...
> * Un gestionnaire d’erreurs par défaut est fourni par défaut pour afficher les messages d’erreur sur les champs si la réponse à l’erreur se trouve dans le schéma standard. Le gestionnaire d’erreurs par défaut peut également appeler le gestionnaire d’erreurs personnalisé si la réponse à l’erreur ne respecte pas le schéma standard.
...
1. Accédez à `[AEM Forms as a Cloud Service repository folder]/apps/[AEM Project Folder]/clientlibs/`.
...
Ajoutons le code suivant au fichier JavaScript pour afficher la réponse et les en-têtes, reçus du point d’entrée du service REST, dans la console du navigateur.
       ...
       * @name customErrorHandler Fonction de gestionnaire d’erreurs personnalisée
       * @errorHandler
       */
       function customErrorHandler(response, headers)
       {
       console.log(&quot;Démarrage du traitement du gestionnaire d’erreurs personnalisé...&quot;);
       console.log(&quot;response:&quot;+JSON.stringify(response));
       console.log(&quot;headers:&quot;+JSON.stringify(headers));
       console.log(&quot;Fin de traitement du gestionnaire d’erreurs personnalisé...&quot;);
       }
       &quot;
...
1. Sélectionnez les liaisons de données dans la **Sortie** . Par exemple, sélectionnez Sélectionner . **Nom du paramètre prédéfini** dans le **Sortie** .
1. Sélectionner **[!UICONTROL Gestionnaire d’erreurs personnalisé]** de la **[!UICONTROL Gestionnaire d’erreurs]** .
1. Cliquez sur **[!UICONTROL Terminé]**.

![ajout d’un gestionnaire d’erreurs personnalisé dans un formulaire pour gérer les réponses d’erreur](/help/forms/assets/custom-error-handler.png)
