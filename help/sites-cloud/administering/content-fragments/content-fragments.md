...
* **Ressources insérées dans un fragment (fragments de supports variés)**
   ...
   * Peuvent uniquement être ajoutées, supprimées ou déplacées dans un fragment à l’aide de [Format Texte enrichi dans l’éditeur de fragments](/help/sites-cloud/administering/content-fragments/content-fragments-variations.md#inserting-assets-into-your-fragment).
...
* **Variations**
   ...
   * Les variations peuvent être [synchronisé](/help/sites-cloud/administering/content-fragments/content-fragments-variations.md#synchronizing-with-master) par Principal si le contenu du Principal a été mis à jour.
