...
* incorporez facilement vos [fragments de contenu &#x200B;](/help/sites-cloud/administering/content-fragments/overview.md) dans votre [e-mail Journey Optimizer](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/channels/email/email-landing-page) contenu
