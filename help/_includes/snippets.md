...
* [Envoyer à l’aide du modèle de données de formulaire](/help/forms/integrate-adaptive-form-with-fdm.md)
...
<table>
  ...
  <tr>
    ...
    <td>La liste déroulante des options est définie à l’aide de la propriété <b>Invoke Service</b> de l’éditeur de règles. 
   </td>
   </tr>
     </tr>
   <tr>
   ...
   <tr>
    <td>Prise en charge de la version ECMAScript</td>
    <td>Prend en charge les fonctionnalités JavaScript ES5 uniquement.</td>
...
>
>* L’[éditeur universel](https://www.aem.live/docs/aem-authoring) pour modifier visuellement du contenu découplé.
...
Pour accélérer la création des sites, Adobe fournit un certain nombre de modèles adaptés à différents objectifs.
