...
Vous pouvez créer une nouvelle configuration sur les E/S Adobe pour configurer AEM Assets avec Brand Portal.
...
* [Publication de fichiers depuis AEM Assets vers Brand Portal](publish-to-brand-portal.md#publish-assets-to-bp)
...
La distribution contient les journaux suivants :
...
* DSTRQ3 (Demande 3) : Le système déclenche une autre demande pour publier le dossier dans lequel le fichier existe et répliquera le dossier dans Brand Portal.
