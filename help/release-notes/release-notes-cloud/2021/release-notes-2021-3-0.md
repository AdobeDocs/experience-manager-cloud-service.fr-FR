...
* Possibilité de filtrer les résultats d’ACS Commons du rapport BPA dans l’interface utilisateur et du rapport exporté sous la forme d’un fichier CSV.
...
* Nouvelles fonctionnalités et améliorations pour Dispatcher Converter. Voir [Ressource GitHub : Dispatcher Converter](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter)
