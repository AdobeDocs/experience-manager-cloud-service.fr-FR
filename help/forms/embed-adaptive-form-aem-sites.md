...
description: Vous pouvez utiliser le composant Forms adaptatif - Incorporer pour incorporer le Forms adaptatif dans une page AEM Sites, ce qui vous permet de remplir et d’envoyer un formulaire sans quitter les pages AEM Sites.
...
1. Ouvrez le dossier Référentiel Git AEM Cloud Service dans un éditeur de texte de plan. Par exemple, Microsoft® Visual Code.
...
1. Ouvrez la page AEM Sites ou le fragment d’expérience à modifier. Pour ouvrir la page à modifier, sélectionnez-la, puis cliquez sur **[!UICONTROL Modifier]**.
...
1. Dans la barre de menu, sélectionnez l’![icône de conversion en variation de fragment d’expérience](/help/forms/assets/Smock_FilingCabinet_18_N.svg) icône de conversion en variation de frangment d’expérience.
