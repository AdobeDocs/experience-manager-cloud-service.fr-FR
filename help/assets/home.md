...
description: Ressources Adobe Experience Manager en tant que ressources d’aide autonome du service Cloud et liens vers la documentation
...
Cette page répertorie les ressources d’auto-assistance relatives aux ressources en tant que service Cloud.

## Ressources clés en tant qu’articles de service Cloud {#key-articles}

* [Présentation des ressources en tant que service Cloud](overview.md)
* [Architecture des ressources en tant que service Cloud](architecture.md)
