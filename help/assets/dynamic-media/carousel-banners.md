...
1. [Ajoutez des zones réactives ou cliquables dans une bannière d’image.](#adding-hotspots-or-image-maps-to-an-image-banner)
   ...
   [ Voir ](#optional-previewing-carousel-banners)(Facultatif) Prévisualisation des bannières du carrousel. - Facultatif. Si vous le souhaitez, vous pouvez afficher une représentation de l’ensemble de carrousel et tester son interactivité.
...
1. Utilisez l’une des méthodes suivantes :
   ...
   * [Ajout d’une bannière de carrousel à votre site Web dans AEM
      ](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)Si vous êtes un client AEM Sites, vous pouvez ajouter le carrousel défini directement à la page dans AEM, à l’aide du composant Interactive Media.


If you need to edit Carousel Sets, see [editing Carousel Sets.](#editing-carousel-sets) En outre, vous pouvez afficher et modifier les propriétés [de la visionneuse de](/help/assets/manage-digital-assets.md#editing-properties)carrousel.
...
>[!NOTE]
>
>When you add hotspots to an image in an [Interactive Image](/help/assets/dynamic-media/interactive-images.md) or a Carousel Banner, the hotspot information is stored in the same metadata location—relative to the image&#39;s location&amp;mdashregardless of whether it is an Interactive Image or a Carousel Banner. Cette fonctionnalité vous permet de réutiliser facilement la même image (ainsi que ses données de zone réactive définies) dans l’une ou l’autre visionneuse.
...
1. Effectuez l’une des actions disponibles sur l’onglet **[!UICONTROL Actions]** :
   ...
   * Appuyez sur **[!UICONTROL Aperçu rapide]**.
      ...
      * If you are an AEM Sites <!-- and Ecommerce customer-->, tap the Product Picker icon (magnifying glass) to open the Select Product page. Appuyez sur le produit que vous souhaitez utiliser, puis cochez la coche dans le coin supérieur droit de la page pour revenir à l’éditeur de bannière de carrousel.
      * Si vous n’êtes pas un site AEM <!-- or Ecommerce customer -->
...
* Ajouter des diapositives à l’ensemble de carrousel. See also [Working with Selectors](/help/assets/dynamic-media/working-with-selectors.md).
...
* Ajouter ou modifier des zones réactives et des zones cliquables. See also [Working with Selectors](/help/assets/dynamic-media/working-with-selectors.md).
