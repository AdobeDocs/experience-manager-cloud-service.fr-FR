...
1. Cliquez sur **[!UICONTROL Ajouter un gestionnaire de succès]**. L’éditeur de règles **[!UICONTROL Invoke Service Success Handler]** s’ouvre.
1. Dans la section **[!UICONTROL Then]**, ajoutez une règle pour définir la valeur de **[!UICONTROL Pet Name]** sur **`name`** à l’aide des données eventpayload.
1. Cliquez sur **[!UICONTROL Terminé]** pour fermer l’éditeur **[!UICONTROL Invoquer le gestionnaire de succès du service]**.
1. Cliquez sur **[!UICONTROL Ajouter un gestionnaire d’échec]**. L’éditeur de règles **[!UICONTROL Invoke Service Failure Handler]** s’ouvre.
1. Dans la section **[!UICONTROL Then]**, sélectionnez **[!UICONTROL Function Output]** et choisissez **[!UICONTROL Default Error Handler]**.
1. Cliquez sur **[!UICONTROL Terminé]** pour fermer l’éditeur **[!UICONTROL Invoquer le gestionnaire d’échec de service]**.
...
Pour comprendre comment créer et utiliser un gestionnaire d’erreurs personnalisé à l’aide de l’action [Service Invoke de l’éditeur de règles](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-rules-and-use-expressions-in-an-adaptive-form/rule-editor.html?lang=en#invoke), prenons un exemple de formulaire adaptatif avec deux champs, **Identifiant d’animal domestique** et **Nom de l’animal domestique** et utilisez un gestionnaire d’erreurs personnalisé sur le champ **Identifiant d’animal domestique** pour vérifier les différentes erreurs renvoyées par le point d’entrée REST configuré pour appeler un service externe, par exemple : `200 - OK`,`404 - Not Found`, `400 - Bad Request`.
...
1. Cliquez sur **[!UICONTROL Terminé]** pour fermer l’éditeur **[!UICONTROL Invoquer le gestionnaire de succès du service]**.
1. Cliquez sur **[!UICONTROL Ajouter un gestionnaire d’échec]**. L’éditeur de règles **[!UICONTROL Invoke Service Failure Handler]** s’ouvre.
1. Dans la section **[!UICONTROL Then]**, sélectionnez **[!UICONTROL Function Output]** et choisissez **[!UICONTROL Custom Error Handler Function]**.
1. Cliquez sur **[!UICONTROL Terminé]** pour fermer l’éditeur **[!UICONTROL Invoquer le gestionnaire d’échec de service]**.
1. Cliquez sur **[!UICONTROL Terminé]** pour enregistrer la règle.
