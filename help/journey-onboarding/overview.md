...
Félicitations pour avoir choisi AEM as a Cloud Service. Ce document constitue le point de départ d’un parcours guidé tout au long du processus d’intégration. Que vous déployiez une nouvelle application ou migriez une application existante, ce parcours d’intégration garantit que vos équipes sont prêtes et qu’elles ont accès à AEM as a Cloud Service.
...
* Ayez accordé à l’utilisateur ou l’utilisatrice nécessaire l’accès à AEM as a Cloud Service.
...
Le parcours d’intégration est écrit spécifiquement pour l’**administrateur système** des nouveaux clients d’AEM as a Cloud Service et d’AEM en général. L’administrateur ou l’administratrice système est la personne qui est contactée pour la première fois par Adobe après la signature de votre contrat AEM as a Cloud Service. Il s’agit généralement de la première personne à accéder à vos ressources et à les configurer sur AEM as a Cloud Service. Si vous lisez cette rubrique, il est probable que vous soyez l’administrateur ou l’administratrice système.
...
>[!NOTE]
>
>Edge Delivery Services est un nouvel ensemble de services composables qui permet un environnement de développement rapide dans lequel les auteurs peuvent rapidement mettre à jour et publier, et où de nouveaux sites sont lancés rapidement. Pour en savoir plus sur les services Edge Delivery, voir [Page de prise en main](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/edge-delivery/overview.html).
