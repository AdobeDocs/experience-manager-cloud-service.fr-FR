...
* Les pièces jointes comprennent un nom de fichier qui commence par (.) , contient \ / : * ? &quot; &lt; > | % $ ou qui contient des noms de fichier spéciaux réservés au système d’exploitation Windows, tels que `nul`, `prn`, `con`, `lpt` ou `com`.
...
### Chemin de transfert et URL de redirection
...
## Création d’une action Envoyer personnalisée
