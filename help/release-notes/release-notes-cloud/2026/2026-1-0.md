---
title: Notes de mise à jour de la version 2026.1.0 d’ [!DNL Adobe Experience Manager] as a Cloud Service.
description: Notes de mise à jour de la version 2026.1.0 d’ [!DNL Adobe Experience Manager] as a Cloud Service.
feature: Release Information
role: Admin
exl-id: 52945f13-2c0a-463d-b2f8-cbb0c305e1d3
source-git-commit: 6f5b7cd108820956d05facd30c25509bce7a3a40
workflow-type: tm+mt
...
# Notes de mise à jour 2026.1.0 pour [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

La section ci-dessous présente les notes de mise à jour techniques de la version 2026.1.0 d’[!DNL Experience Manager] as a Cloud Service.
...
La date de publication de la version actuelle (2026.1.0) de [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] est le 29 janvier 2026. La prochaine version des fonctionnalités (2026.2.0) est prévue pour le 3 mars 2026.
...
Regardez la vidéo Aperçu de la version de janvier 2026 pour un résumé des fonctionnalités ajoutées dans la version 2026.1.0 :
...
En savoir plus dans [Utilisation de MCP avec AEM Cloud Service](/help/ai-in-aem/mcp-support/using-mcp-with-aem-as-a-cloud-service.md). Pour toute question ou commentaire, envoyez un e-mail à l’adresse [&#128279;](mailto:aemcs-mcp-feedback@adobe.com).
...
Envoyer un courrier électronique à l’adresse [&#128279;](mailto:aemcs-java-adopter@adobe.com) pour plus d’informations.
