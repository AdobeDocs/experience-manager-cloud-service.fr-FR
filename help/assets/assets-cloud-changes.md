...
* [!DNL Experience Manager] utilise le principe d’accès binaire direct pour charger et télécharger des ressources, ainsi que des microservices de ressources pour les traiter. Voir un [aperçu des microservices](/help/assets/asset-microservices-overview.md).
...
Les microservices de ressources, natifs dans le cloud, sont automatiquement mis en service et connectés à [!DNL Experience Manager] dans les programmes et environnements clients gérés dans Cloud Manager. Pour étendre ou personnaliser [!DNL Experience Manager], les développeurs peuvent utiliser du contenu ou des ressources existants avec des rendus générés dans un environnement cloud. Cette fonctionnalité leur permet de tester et valider leur code à l’aide, de l’affichage ou du téléchargement de ressources.
...
| Traitement des ressources chargées à l’aide du gestionnaire de packages | Ceci nécessite une intervention manuelle | Retraitez manuellement les ressources à l’aide de l’action **[!UICONTROL Retraiter la ressource]**. |
...
| Traduction intelligente | Non pris en charge. | La traduction dynamique n’est pas prise en charge dans [!DNL Experience Manager] en tant que [!DNL Cloud Service]. |
