---
title: 'Application d’une liste d’adresses IP autorisées '
...
# Application d’une liste d’adresses IP autorisées {#apply-allow-list}
...
>[!NOTE]
>La liste d’adresses IP autorisées doit exister dans Cloud Manager pour pouvoir l’appliquer à un environnement-service.
