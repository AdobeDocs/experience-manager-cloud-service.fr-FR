...
Historiquement, le réseau de diffusion de contenu délivre 3,5 pétaoctets de trafic aux clients, chaque mois. Le système peut délivrer 52 milliards de ressources en une seule journée. Ce nombre équivaut à 864 000 images et vidéos diffusées avec succès aux clients, _toutes les secondes_.
...
L’un des cas d’utilisation les plus importants pour Dynamic Media est également l’un des plus évidents. À savoir : réduire le poids des pages et des expériences, ainsi que la taille du contenu, qu’il s’agisse de la diffusion d’une image ou d’une vidéo.
...
L’URL ci-dessus est en ligne ! [Faites un essai](http://s7d1.scene7.com/is/image/jpearldemo/AdobeStock_28563982?$Large$).
