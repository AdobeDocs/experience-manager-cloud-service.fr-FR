...
![Boîte de dialogue Paramètres Claude.](assets/claude-1.png)

![Panneau Connecteurs de Claude.](assets/claude-2.png)

![Ajout d&#39;un connecteur personnalisé dans Claude.](assets/claude-3.png)

![Connexion du connecteur personnalisé dans Claude.](assets/claude-4.png)

![Formulaire de configuration de connecteur personnalisé dans Claude.](assets/claude-5.png)

![Boîte de dialogue Autorisations de l’outil pour le connecteur personnalisé.](assets/claude-6.png)

![Inviter Claude à utiliser le service AEM Content MCP.](assets/claude-7.png)
