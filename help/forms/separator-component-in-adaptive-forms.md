---
title: En quoi consiste le composant séparateur dans le Forms adaptatif ?
description: Le composant Séparateur dans le Forms adaptatif permet de séparer visuellement les sections d’un formulaire.
...
1. Dans le champ adjacent, spécifiez une valeur valide pour la propriété CSS3 spécifiée. Par exemple, 3 pixels de **sont entièrement noirs**.
...
1. Utilisez l’une des méthodes suivantes :
   ...
   * Fermez la boîte de dialogue sans apporter de modifications en cliquant sur **Annuler**.
