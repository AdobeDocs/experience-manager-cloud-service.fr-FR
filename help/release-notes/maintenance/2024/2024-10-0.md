...
L’activation de la fonctionnalité 2024.10.0 fournit l’ensemble des fonctionnalités de cette version de maintenance. Voir [Feuille de route des versions d’Experience Manager](https://experienceleague.adobe.com/fr/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap) pour plus d’informations.
...
* ASSETS-41684 : ajoutez des configurations OSGI prêtes à l’emploi pour définir le mappage FI pour le groupe pour Assets, Foundation, Sites et Forms.
...
* GUIDES-19069 : Ajout de guidesPeerLinkIndex pour le module complémentaire de guides d’AEM.
...
Vous devez passer à [l’API d’utilisation de Java,](https://experienceleague.adobe.com/fr/docs/experience-manager-htl/content/java-use-api) qui offre de meilleures performances, un débogage plus facile et une prise en charge plus étendue à long terme.
...
* FORMS - 16096 : l’utilisateur Forms n’a pas accès à la boîte de dialogue du point de terminaison rest.
...
* SITES - 23961 : Eventing : la création de modèles de fragment de contenu avec des références échoue en présence d’un dossier de configuration
...
* SITES - 16357 : AEM : le bouton est tronqué dans l’onglet Configuration d’Analytics dans le menu Sites.
