...
* L’opération de suppression a été améliorée pour les sites web [Edge Delivery](/help/edge/overview.md) en mettant à jour les mappages de domaine du programme associé à ce site.
