...
| Page d’accueil | Non pris en charge. | Voir [[!DNL Assets] Expérience de page d’accueil dans [!DNL Experience Manager] 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/assets-home-page.html?lang=fr) |
