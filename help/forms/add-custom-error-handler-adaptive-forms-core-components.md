...
# Gestionnaires d’erreurs pour les formulaires adaptatifs basés sur les composants principaux {#error-handlers-in-adaptive-form}
...
* `errors` mentionne l’expression des champs qui ont échoué aux critères de validation avec le message d’erreur de validation.
...
* [Activer les composants principaux des formulaires adaptatifs pour votre environnement AEM Cloud Service](enable-adaptive-forms-core-components.md).
...
![ajouter un gestionnaire d’erreurs personnalisé dans un formulaire pour gérer les réponses aux erreurs](/help/forms/assets/custom-error-handler.png) s
