...
Edge Delivery Services est un ensemble de services composable qui offre une grande flexibilité quant à la manière dont vous créez du contenu sur votre site web. Vous pouvez utiliser la [gestion de contenu AEM](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/sites/authoring/author-publish) et la création WYSIWYG à l’aide de l’[éditeur universel](/help/sites-cloud/authoring/universal-editor/authoring.md), ainsi que la [création basée sur des documents](https://www.aem.live/docs/authoring).
...
* Pour une vue d’ensemble de l’éditeur universel et de la création WYSIWYG, consultez [Création de contenu WYSIWYG pour Edge Delivery Services](/help/edge/wysiwyg-authoring/authoring.md).
* Pour une vue d’ensemble destinée aux développeurs et développeuses, consultez le [Guide de prise en main pour le développement pour la création WYSIWYG avec Edge Delivery Services](/help/edge/wysiwyg-authoring/edge-dev-getting-started.md).
...
Pour plus d’informations, consultez [Choix d’une méthode de création](authoring-methods.md).
...
Il est facile de commencer à utiliser Edge Delivery Services en suivant le tutoriel [Prise en main - Tutoriel de développement](https://www.aem.live/developer/tutorial).
