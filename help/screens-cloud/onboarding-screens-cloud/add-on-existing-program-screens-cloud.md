...
Les étapes suivantes vous aideront à découvrir comment ajouter un module complémentaire Screens à un programme existant dans Cloud Manager.
...
1. Accédez à votre projet et cliquez sur l’option **Modifier le programme** de la page Cloud Manager **Aperçu**.

   ![Modifier le programme](/help/screens-cloud/assets/onboarding/add-onexisting1.png)
