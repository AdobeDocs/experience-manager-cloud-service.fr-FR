...
# Création AEM avec Edge Delivery Services {#edge-dev-getting-started}
...
Ce guide porte sur les projets AEM réalisés sur Edge Delivery Services à l’aide de l’éditeur universel. Voir le document [Développement pour Edge Delivery Services](/help/edge/developing.md) pour en savoir plus sur le choix de l’éditeur approprié et la migration d’AEM Sites existants vers Edge Delivery Services.
...
1. Revenez à la racine de votre référentiel et cliquez sur `paths.yaml`, puis sur l’icône **Modifier ce fichier**.

   ![paths.yaml](assets/edge-dev-getting-started/paths.png)

1. Remplacez les mappages par défaut par `/content/<site-name>/:/`, puis cliquez sur **Valider les modifications...**.
...
1. Demandez le dernier modèle de site de création AEM avec Edge Delivery Services à l’équipe d’ingénierie d’Adobe via votre [canal de projet Slack.](/help/edge/docs/slack.md)
