...
1. Avec le type MIME `image_vnd.dwg` sélectionné toujours, dans la **[!UICONTROL Propriétés]** , dans le **[!UICONTROL enabled]** , sous **[!UICONTROL Valeur]** en-tête de colonne, double-sélectionnez la valeur. La liste déroulante **[!UICONTROL Valeur]** est ouverte.
