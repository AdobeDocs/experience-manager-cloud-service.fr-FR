...
| Création basée sur des documents | [Cliquez ici](/help/edge/docs/forms/tutorial.md) |
...
![Workflow du référentiel Github](/help/edge/assets/repo-workflow.png){width="50%" align="center" height="50%"}
