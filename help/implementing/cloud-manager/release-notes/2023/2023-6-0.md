...
* Lors de la création d&#39;un [programme ou environnement,](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/program-types.md), le nom est désormais limité à l&#39;acceptation de caractères alphanumériques et d&#39;un ensemble limité de caractères spéciaux.
