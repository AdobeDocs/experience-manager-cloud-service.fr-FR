...
* (Obligatoire) *Extension du service* d’ID d’expérience Cloud
...
* Le noeud d’auteur AEM est configuré dans Contenu multimédia dynamique. <!-- Scene7 run mode (dynamicmedia_s7) -->
