...
* Capacité à détecter les ressources non traitées. Si des ressources non traitées sont détectées, elles doivent être définies sur Traité ou être supprimées de l’ensemble de migration lors du transfert de contenu afin d’éviter des problèmes lors de l’ingestion de contenu.
