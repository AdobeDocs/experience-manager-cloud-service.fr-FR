...
1. Sélectionner **Comparer à actuel**. Le [comparaison des pages](/help/sites-cloud/authoring/features/page-diff.md) ouvre et affiche les différences.
...
1. La page s’affiche en fonction du jeu de dates. Le mode Timewarp est indiqué par la barre d’état bleue située en haut de la fenêtre. Utilisez les liens de la barre d’état pour sélectionner une nouvelle date cible ou quitter le mode Timewarp.
...
* **Timewarp est en lecture seule** : vous ne pouvez pas modifier l’ancienne version de la page. Elle est disponible uniquement à des fins d’affichage. Si vous souhaitez restaurer l’ancienne version, vous devez effectuer cette opération manuellement à l’aide de [restore](#revert-to-a-version).
