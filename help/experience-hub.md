...
Experience Hub offre un point de départ centralisé pour la gestion du contenu, des ressources et des sites dans Adobe Experience Manager. Conçu pour offrir une expérience personnalisée, Experience Hub vous permet de naviguer de manière fluide à travers l’écosystème AEM en fonction de vos rôles et objectifs. Il fournit des informations clés et des actions recommandées pour vous aider à atteindre efficacement vos objectifs. Avec une interface claire et centrée sur les utilisateurs et les utilisatrices, la page d’accueil d’Experience Hub facilite un accès rapide aux outils essentiels et offre une expérience efficace et rationalisée pour utiliser toutes les fonctionnalités d’AEM.

Voir aussi [AEM Experience Hub](https://developer.adobe.com/uix/docs/services/aem-experience-hub/).

Affichez un aperçu de l’espace de travail AEM Experience Hub (2 minutes, 40 secondes).
...
## Présentation d’Experience Hub {#aem-experience-hub-about}
...
Ces solutions ont été déplacées vers la navigation principale sous **Outils** ou **Services**. Les nouveaux éléments de navigation permettent d’accéder rapidement aux fonctionnalités d’AEM liées à vos solutions activées. Accédez à Assets, Sites, Forms, Fragments de contenu, Lancements, etc.
...
La section **Environnements de création** répertorie tous les environnements AEM auxquels vous pouvez accéder et inclut des raccourcis vers leurs solutions et pages. Pour conserver des environnements spécifiques en haut de la liste, épinglez-les.

La section **Récents**, illustrée dans l’image ci-dessous, répertorie les pages que vous avez récemment visitées dans AEM. Selon la licence de votre client, le widget inclut des éléments tels que le programme, l’exécution du pipeline et divers éditeurs.
...
Experience Hub affiche des vues basées sur les rôles et des actions rapides pour les auteurs, les bibliothécaires de ressources, les administrateurs et le personnel informatique. Chaque rôle bénéficie d’un accès rapide aux outils et fonctionnalités dont il a besoin.
...
Experience Hub propose des raccourcis en un clic pour les tâches courantes, adaptés au rôle de l’utilisateur.
