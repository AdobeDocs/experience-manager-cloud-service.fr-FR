...
La fonctionnalité Multi Site Manager (MSM) dans [!DNL Adobe Experience Manager] permet aux utilisateurs de réutiliser du contenu créé une fois et réutilisé sur plusieurs emplacements web. La même fonctionnalité est disponible pour les ressources numériques sous le nom MSM pour [!DNL Assets]. En utilisant MSM pour [!DNL Assets], vous pouvez :
...
* La configuration des verrous MSM sur les propriétés de page n’est pas prise en charge dans MSM pour [!DNL Assets].
