...
- [Ajout de fragments de formulaire dans un formulaire](#adding-form-fragments-to-a-form)
...
- Implémenter des modèles de formulaire basés sur des fragments pour des expériences d’utilisation cohérentes
