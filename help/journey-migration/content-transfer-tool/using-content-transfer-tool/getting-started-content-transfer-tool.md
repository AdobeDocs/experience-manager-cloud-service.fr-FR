...
Seules les versions 2.0.0 et ultérieures seront prises en charge et il est conseillé d’utiliser la version la plus récente.
...
>additional-url="https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/content-transfer-tool.html#migration" text="Tutoriel – Utilisation de l’outil de transfert de contenu"
...
1. Créez un jeu de migration en cliquant sur **Créer un jeu de migration**.
   ...
   >[!NOTE]
   >
   >Vous pouvez créer au maximum cinq jeux de migration, y compris les jeux expirés, par projet dans Cloud Acceleration Manager.
...
1. Cliquez sur **Check Size** (Vérifier la taille) pour démarrer le processus. Vous revenez alors à la vue Liste des jeux de migration et un message vous indique que **Vérifier la taille** est en cours d’exécution.
