...
description: Découvrez comment automatiser la création d’ensembles d’images et de visionneuses à 360° à l’aide des paramètres prédéfinis de lot de Dynamic Media.
...
Utilisez les **[!UICONTROL paramètres prédéfinis de lot]** pour créer et organiser différentes ressources dans un ensemble d’images ou une visionneuse à 360° lorsque vous chargez des fichiers de ressources dans un dossier, individuellement ou par une ingestion en masse. Il est possible d’exécuter le paramètre prédéfini en même temps que les tâches d’import de ressources planifiées dans [!DNL Dynamic Media]. Chaque paramètre prédéfini est un ensemble d’instructions indépendant possédant un nom unique. Il définit comment construire l’ensemble d’images ou la visionneuse à 360° à l’aide d’images correspondant aux conventions d’affectation des noms définies dans la recette du paramètre prédéfini.
...
1. Créez un paramètre prédéfini de lot. Voir [Création d’un paramètre prédéfini de lot pour un ensemble d’images ou une visionneuse à 360°](#creating-bsp).
...
1. Chargez les images vers le dossier de ressources. Voir [Chargement de ressources pour les ensembles d’images](/help/assets/dynamic-media/image-sets.md#uploading-assets-in-image-sets), [Chargement de ressources pour les visionneuses à 360°](/help/assets/dynamic-media/spin-sets.md#uploading-assets-for-spin-sets) ou [Ajout de ressources numériques à Adobe Experience Manager](/help/assets/add-assets.md#add-assets-to-experience-manager).
1. L’ensemble d’images ou la visionneuse à 360° est généré automatiquement dans le dossier souhaité.
1. Publiez votre ensemble d’images ou votre visionneuse à 360°. Voir [Publication de ressources Dynamic Media](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md).

## Création d’un paramètre prédéfini de lot pour un ensemble d’images ou une visionneuse à 360° {#creating-bsp}
...
Bien qu’un tri séquentiel forcé soit possible, il est préférable de se baser autant que possible sur la numérotation alphanumérique pour le tri séquentiel. En outre, vous pouvez utiliser les outils d’éditeur d’ensemble d’images ou de visionneuse à 360° de [!DNL Dynamic Media] pour réorganiser l’ordre séquentiel des ressources, ou ajouter et supprimer de nouvelles ressources dans la visionneuse par une opération glisser-déposer.
...
**Pour créer un paramètre prédéfini de lot pour un ensemble d’images ou une visionneuse à 360° :**
...
1. Créez un ou plusieurs groupes d’expressions régulières.
   ...
   * Avec les listes déroulantes et les zones de texte du formulaire du groupe, spécifiez un groupe d’expressions que vous souhaitez utiliser pour définir les critères d’affectation de noms pour les ressources de l’ensemble d’images ou de la visionneuse à 360°.
      * Lorsque vous sélectionnez et spécifiez des expressions pour un groupe, notez que la syntaxe réelle de l’expression régulière est reflétée en bas, à droite de la page, sous l’en-tête **[!UICONTROL Résultats de la règle – RegX]**. Pour afficher la chaîne d’expression régulière mise à jour en bas à droite, sélectionnez n’importe où en dehors de la zone de formulaire. Ces chaînes d’expression régulière représentent le modèle que vous souhaitez mettre en correspondance dans une recherche de ressources [!DNL Dynamic Media] pour créer votre ensemble d’images ou votre visionneuse à 360°.
...
Voir [Création d’un paramètre prédéfini de lot pour un ensemble d’images ou une visionneuse à 360°](#creating-bsp) ou [Modification d’un paramètre prédéfini de lot](#edit-bsp).
...
1. Sous **[!UICONTROL Paramètres prédéfinis de lot]**, sélectionnez le nom d’un paramètre prédéfini de lot à appliquer dans la liste déroulante **[!UICONTROL Nom du paramètre prédéfini]**. La capture d’écran ci-dessus montre deux paramètres prédéfinis de lot sélectionnés, appliqués au dossier de ressources.
   ...
   S’il n’existe aucun nom de paramètre prédéfini de lot dans la zone de liste déroulante **[!UICONTROL Nom du paramètre prédéfini]**, cela signifie que vous n’avez pas encore créé ce paramètre. Voir [Création d’un paramètre prédéfini de lot pour un ensemble d’images ou une visionneuse à 360°](#creating-bsp).
...
Toutefois, vous ne pouvez pas modifier le nom ni le type de paramètre prédéfini (ensemble d’images ou visionneuse à 360°). S’il devient nécessaire de modifier le nom d’un paramètre prédéfini, copiez le paramètre prédéfini existant et spécifiez un nouveau nom. Voir [Copie d’un paramètre prédéfini de lot](#copy-bsp).
...
Si vous souhaitez que ce paramètre prédéfini modifié soit réappliqué aux ressources existantes du dossier, vous devez retraiter le dossier. <!-- See [Reprocessing assets in a folder](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets). -->Ainsi, les ressources existantes pourraient désormais être incluses dans un ensemble d’images ou une visionneuse à 360° et y être ajoutées. En outre, les ressources existantes qui étaient déjà incluses dans l’ensemble d’images ou la visionneuse à 360°, en fonction du paramètre prédéfini de lot précédent utilisé, ne sont pas supprimées et sont affichées en l’état. Ce scénario suppose qu’ils ne sont plus qualifiés en fonction du paramètre prédéfini nouvellement modifié.
...
Vous pouvez copier un paramètre prédéfini de lot existant pour éviter d’avoir à recréer manuellement un paramètre prédéfini complexe ou simplement pour renommer un paramètre prédéfini. Toutefois, vous ne pouvez pas modifier le type de paramètre prédéfini (ensemble d’images ou visionneuse à 360°).
...
Lorsque vous supprimez des paramètres prédéfinis de lot dans des dossiers, les nouvelles ressources chargées vers ces dossiers ne seront pas associées au paramètre prédéfini de lot. Les ressources existantes du dossier déjà ajoutées à l’ensemble d’images ou à la visionneuse à 360°, en fonction du paramètre prédéfini de lot appliqué au dossier, continuent à s’afficher en l’état.
...
Si vous supprimez un paramètre prédéfini précédemment appliqué à un ou plusieurs dossiers, les visionneuses à 360° ou les ensembles d’images créés à partir de ressources de ces dossiers continuent de s’afficher en l’état.
...
>[!MORELIKETHIS]
>
>* [Ensembles d’images](/help/assets/dynamic-media/image-sets.md)
