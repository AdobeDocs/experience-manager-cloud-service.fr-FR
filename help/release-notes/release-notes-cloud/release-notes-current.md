...
La date de publication de la version actuelle de [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] (2025.1.0) est le 30 janvier 2025. La prochaine disponibilité des fonctionnalités (2025.2.0) est prévue pour le mercredi 4 mars 2025.
...
[Les fonctionnalités de l’application web progressive (PWA)](/help/sites-cloud/authoring/sites-console/enable-pwa.md) pour AEM Sites sont obsolètes pour les nouveaux projets à partir de la version 2025.1.0. Cette fonctionnalité reste prise en charge pour les projets existants, mais ne doit pas être utilisée pour les nouveaux projets
...
Personnalisez facilement des bannières d’images et de texte à la volée à l’aide de l’éditeur de modèles de Dynamic Media WYSIWYG. En outre, en incorporant l’URL dans une application tierce ou propriétaire, vous bénéficiez d’expériences attrayantes grâce aux mises à jour de contenu de bannières en temps réel.
...
#### Amélioration de l’expérience d’utilisation avec les boutons de navigation dans les dispositions de panneau

Vous pouvez désormais ajouter des boutons de navigation à vos dispositions de panneau, tels que les onglets horizontaux, verticaux, accordéons ou assistants. Ces boutons [optimisent l’expérience d’utilisation en simplifiant les transitions entre les panneaux et en mettant l’accent sur le panneau sélectionné](/help/forms/rule-editor-core-components-usecases.md#navigating-among-panels-using-button).
...
Les API de génération de documents AEM Forms vous permettent désormais de [charger directement les documents PDF générés vers le stockage Blob Azure](/help/forms/early-access-ea-features.md#doc-generation-api). Cette amélioration simplifie le stockage et la récupération, améliorant l’efficacité et l’intégration aux workflows cloud.
