...
Pour plus d’informations sur le SDK AEM découplé, consultez la [documentation ici](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/how-to/aem-headless-sdk.html?lang=fr).
