...
* **Améliorations de l’extensibilité pour les équipes de développement :** l’éditeur universel prend désormais en charge la diffusion d’événements vers les extensions, permettant aux personnes chargées du développement de s’abonner aux [événements](/help/implementing/universal-editor/events-universal-editor.md).
