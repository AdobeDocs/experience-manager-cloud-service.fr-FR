...
>
>
L’implémentation actuelle de l’API HTTP Ressources est basée sur le style architectural [REST](https://en.wikipedia.org/wiki/Representational_state_transfer) .
