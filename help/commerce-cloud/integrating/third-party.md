...
L’intégration d’une solution de commerce non-Adobe est un scénario courant pour l’environnement CIF. Les solutions tierces avec différents schémas et API sont connectées par le biais d’une couche d’intégration.
...
>[!TIP]
>
>Si aucune API en temps réel n’est disponible, un cache de produit externe avec les API doit être utilisé pour l’intégration. Exemple d’[Adobe Commerce Open Source](https://business.adobe.com/fr/products/magento/open-source.html).
