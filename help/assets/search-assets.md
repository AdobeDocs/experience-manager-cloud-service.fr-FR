...
contentOwner: AG
mini-toc-levels: 1
feature: Recherche, métadonnées, distribution de ressources
...
### Rechercher [!DNL Dynamic Media] ressources {#search-dynamic-media-assets}
