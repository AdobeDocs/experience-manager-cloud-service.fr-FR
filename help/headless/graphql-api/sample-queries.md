...
>[!NOTE]
>
>Selon votre instance, vous pouvez accéder directement à la variable [Interface GraphiQL incluse avec AEM API GraphQL](/help/headless/graphql-api/graphiql-ide.md) pour envoyer et tester des requêtes.
>
