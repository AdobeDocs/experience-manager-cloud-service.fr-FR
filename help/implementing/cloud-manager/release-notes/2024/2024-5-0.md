...
* Le [tableau de bord de licence](/help/implementing/cloud-manager/license-dashboard.md) est désormais accessible par le biais d’un point d’entrée distinct dans la [navigation](/help/implementing/cloud-manager/navigation.md) gauche.
