...
description: Découvrez comment les variations vous permettent de créer du contenu pour le fragment, puis de créer des variantes de ce contenu en fonction de l’objectif. Vous bénéficiez ainsi d’une plus grande flexibilité pour la diffusion headless et la création de pages.
...
[Variations](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment) sont une fonctionnalité importante des fragments de contenu Adobe Experience Manager (AEM). Ils vous permettent de créer et de modifier des copies du contenu principal à utiliser sur des canaux et des scénarios spécifiques, ce qui rend la création de pages et la diffusion de contenu sans interface encore plus flexible.
...
>[!NOTE]
>
>Pour plus d’informations, voir [Markdown](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md).
...
* Indiqué par la mise en surbrillance sur le texte, en mode plein écran et normal de l’éditeur. Les détails complets d’une annotation peuvent ensuite être affichés, modifiés ou supprimés, en cliquant sur le texte mis en surbrillance, ce qui ouvre à nouveau la boîte de dialogue.
...
* Ils peuvent être répertoriés et supprimés en sélectionnant l’option **Annotations** dans l’éditeur de fragments.

  ![annotations](assets/cfm-variations-08.png)

* Ils peuvent être affichés et supprimés dans la variable [Chronologie](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md#timeline-for-content-fragments) pour le fragment sélectionné.
...
1. Utilisez la variable **Insérer une ressource** pour ouvrir la boîte de dialogue de recherche.
...
1. Utilisez la variable **Insérer un fragment de contenu** pour ouvrir la boîte de dialogue de recherche.
...
1. Confirmez le **Supprimer** dans la boîte de dialogue.
...
>
La synchronisation ne fonctionne que sur le **Texte multiligne** type de données.
>
