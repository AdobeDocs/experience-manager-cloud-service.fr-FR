...
| `data-editor-itemmodel` | Définit un modèle qui sera utilisé pour la modification basée sur les formulaires dans le rail des propriétés. |
...
| `component` | L’élément modifiable est un composant. N’ajoute pas de fonctionnalités supplémentaires. Cela sera nécessaire pour indiquer les parties qui peuvent être déplacées/supprimées du DOM et pour ouvrir le rail de propriétés et ses champs. | Requis | n/a | n/a | Facultatif | Facultatif | n/a |
