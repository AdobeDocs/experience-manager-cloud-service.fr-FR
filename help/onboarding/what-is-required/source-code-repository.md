...
Une fois un client Git configuré, vous pouvez gérer votre référentiel Git à partir de l’interface utilisateur de Cloud Manager. Pour savoir comment gérer Git à l’aide de l’interface utilisateur de Cloud Manager, reportez-vous à [Accès à Git](/help/implementing/cloud-manager/accessing-git.md).
