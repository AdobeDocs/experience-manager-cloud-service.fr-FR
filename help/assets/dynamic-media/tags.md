...
Consultez [Éléments de données](https://experienceleague.adobe.com/fr/docs/experience-platform/tags/ui/data-elements) dans le Guide de l’utilisateur Experience Platform Tags.
...
Voir [Règles](https://experienceleague.adobe.com/fr/docs/experience-platform/tags/ui/rules) dans le Guide de l’utilisateur d’Experience Platform Tags.
...
* Le premier appel se produit, car la règle **[!UICONTROL TrackPan]** est déclenchée lorsque l’utilisateur ou l’utilisatrice effectue un panoramique dans la *visionneuse1*. Cet appel envoie **50 %** comme valeur de l’élément de données **[!UICONTROL ZoomScale]**, car il reconnaît que *viewer1* a déclenché la règle et récupère la valeur d’échelle correspondante.
...
En règle générale, les besoins spécifiques à un projet déterminent la manière dont vous configurez un rapport dans Adobe Analytics. La configuration détaillée des rapports dépasse donc le cadre de cette intégration.
...
Voir aussi [Configurer une propriété de sélection](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags).
...
Voir [Extension Adobe Analytics](https://experienceleague.adobe.com/fr/docs/experience-platform/tags/extensions/client/analytics/overview).
...
Il est possible de contourner cette limitation. Spécifiez l’URL de développement ou d’évaluation de la bibliothèque Experience Platform Tags dans la Configuration cloud Experience Platform Tags pour la publication Experience Manager ci-dessus. Cela permet au nœud de publication d’Experience Manager d’utiliser la version de développement ou de préproduction de la bibliothèque de balises Experience Platform.
