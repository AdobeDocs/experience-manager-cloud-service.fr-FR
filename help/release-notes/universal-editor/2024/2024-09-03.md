...
* **Chemin d’accès racine du sélecteur de contenu** : les sélecteurs de contenu [AEM](/help/implementing/universal-editor/field-types.md#aem-content), [Fragment de contenu](/help/implementing/universal-editor/field-types.md#content-fragment) et [Fragment d’expérience](/help/implementing/universal-editor/field-types.md#experience-fragment) prennent désormais en charge une configuration `rootPath`, ce qui limite la sélection au chemin d’accès spécifié et aux sous-répertoires, maintient la cohérence du contenu et accroît l’efficacité de la création.
...
* **Gestion des URL du sélecteur de contenu** : correction de la gestion, par le sélecteur de contenu, des paramètres de requête dans les URL de connexion AEM, en assurant la compatibilité avec des branches d’URL spécifiques ou d’autres paramètres de GET
