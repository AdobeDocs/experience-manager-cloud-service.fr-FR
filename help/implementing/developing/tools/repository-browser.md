...
Pour accéder à AEM Developer Console as a Cloud Service, voir [Accès à Developer Console](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/developer-console#developer-console-access).

Pour accéder à l’explorateur de référentiels, les conditions requises sont les mêmes que pour AEM as a Cloud Service Developer Console (spécifié ci-dessus). Pour afficher le contenu du navigateur de référentiel pour une instance spécifique :

* Instances de création : utilisateurs disposant du profil de produit Utilisateurs AEM pour le **Instance de création** peut afficher le navigateur du référentiel avec un accès en lecture minimal ; les autorisations de l’utilisateur sont respectées lors de la navigation dans le référentiel. Les utilisateurs disposant du profil produit Administrateurs AEM peuvent afficher le navigateur de référentiel avec un accès en lecture complet.

* Instances de publication : utilisateurs disposant du profil de produit Utilisateurs AEM pour le **Instance de publication** peut afficher le navigateur de référentiel avec un accès en lecture minimal. Sans ce jeu de profils de produit, les utilisateurs navigueront en tant qu’utilisateur anonyme et certains chemins ne s’afficheront pas en raison d’autorisations limitées.
