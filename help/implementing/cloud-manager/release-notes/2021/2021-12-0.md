...
description: Notes de mise à jour de Cloud Manager dans AEM as a Cloud Service version 2021.12.0.
...
* Les conseils fournis par la carte call-to-action dans la page d’aperçu ont été actualisés afin de refléter précisément son association avec le pipeline de production de pile pleine.
