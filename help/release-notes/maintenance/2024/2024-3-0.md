...
* ASSETS-35923 : `UnsupportedClassVersionError` à l’étape de création du pipeline CM après la mise à niveau de la version de l’`aem-sdk-api` vers `2024.2.15262.20240224T002940Z-231200`. **L’action du client doit être effectuée pour définir la version Java de CM sur 11**, voir [ Environnement de création / Définition de la version JDK Maven](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md#alternate-maven-jdk-version).
