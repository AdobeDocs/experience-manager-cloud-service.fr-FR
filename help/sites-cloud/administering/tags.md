...
1. La boîte de dialogue **Balise Publish** demande une confirmation pour publier les balises sélectionnées. Sélectionner **Publier**.
...
1. La boîte de dialogue **Annuler la publication de la balise** demande une confirmation pour publier les balises sélectionnées. Sélectionner **Publier**.
