...
+ Ressources {#assets}
   ...
   + Configuration, administration et extension d’[!DNL Assets] {#admin}
      ...
      + [Générer pour placement uniquement les rendus](/help/assets/configure-fpo-renditions.md)
   ...
   + Développement pour AEM as a Cloud Service {#developing}
      ...
      + Développement full stack avec AEM {#full-stack}
         ...
         + Composants et modèles {#components-templates}
            ...
            + [Système de style](https://experienceleague.adobe.com/docs/experience-manager-cloud-service-prerelease/sites/authoring/features/style-system.html)
      ...
      + Gestion de l’expérience découplée {#headless}
         ...
         + Parcours sans affichage {#journeys}
            + Parcours de développement découplé {#developer}
               ...
               + [Comment mettre à jour votre contenu via les API AEM Assets](/help/journey-headless/developer/update-your-content.md)
      ...
      + Développement hybride et SPA {#hybrid}
         ...
         + [Activation de l’exportateur JSON pour un composant](https://experienceleague.adobe.com/docs/experience-manager-cloud-service-prerelease/implementing/developing/full-stack/components-templates/enabling-json-exporter.html)
