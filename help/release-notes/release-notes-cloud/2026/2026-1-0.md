...
# Notes de mise à jour de la version 2026.1.0 d’[!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

La section suivante concerne les notes de mise à jour de la version 2026.1.0 d’[!DNL Experience Manager] as a Cloud Service.
