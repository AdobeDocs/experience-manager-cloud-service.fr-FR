...
![Architecture découplée PWA](/help/commerce-cloud/cif-storefront/assets/PWA-Studio_Architecture.png)
...
1. Ajoutez le wrapper Apollo Link à votre application PWA Studio. Dans `pwa-root/src/index.js`, effectuez les modifications suivantes :
