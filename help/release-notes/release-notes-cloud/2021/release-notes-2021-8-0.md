...
* **Connectez facilement AEM Forms à Microsoft Dynamics et Salesforce.com** : Le service fournit des modèles de données et de configuration de source de données prêts à l’emploi pour Microsoft Dynamics et Salesforce.com, ce qui facilite et accélère la configuration de Microsoft Dynamics et de Salesforce.com en tant que sources de données pour un formulaire adaptatif.
