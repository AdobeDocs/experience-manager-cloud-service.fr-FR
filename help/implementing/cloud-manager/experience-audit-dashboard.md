...
![Cinq plus lents](assets/experience-audit-slowest-five.png)
...
![Rapports de contrôle de l’expérience](assets/experience-audit-reports.png)
...
![Vue Tendance](assets/experience-audit-trend-view.png)
...
![Détails de la tendance](assets/experience-audit-trend-details.png)
...
![Sélectionner une analyse différente](assets/experience-audit-open-scan.png)
...
Cliquez sur le lien d’une page particulière pour mettre à jour le filtre **Sélectionner** de la section [**Scores de page — Tendance** ](#trend) et afficher l’onglet **Rapports bruts** qui vous donne les scores de chaque audit de la page. Cliquez sur la date du rapport dans la colonne **Rapport Lighthouse** pour récupérer un fichier JSON des données brutes.

![Rapport brut](assets/experience-audit-raw-reports.png)

Un nouvel onglet s’ouvre dans votre navigateur pour vous diriger vers `https://googlechrome.github.io/lighthouse/viewer/`. Il charge automatiquement une URL signée contenant le rapport JSON brut Lighthouse pour la page sélectionnée, ce qui permet une inspection détaillée.
...
![Filtre Trigger](assets/experience-audit-on-demand-trigger.png)
...
![Problèmes rencontrés par le contrôle de l’expérience](assets/experience-audit-issues.png)
...
![Problèmes de rapport complet](assets/experience-audit-issues-report.png)
...
* Les pages affichées dans la liste déroulante **Sélectionner** de la section [**Scores de page — Tendance** ](#trend) sont toutes des pages connues que le contrôle de l’expérience a parcourues par le passé.
