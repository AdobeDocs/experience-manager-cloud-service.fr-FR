...
### Si vous utilisez AEM ciblage ou Adobe Target (ciblage d’expérience) {#if-you-are-using-aem-targeting-or-adobe-target-experience-targeting}
...
### Si vous utilisez les tests A/B (Adobe Target) {#if-you-are-using-a-b-testing-adobe-target}
