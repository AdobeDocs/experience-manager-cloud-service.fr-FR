...
Au lieu d’exiger l’enregistrement du site, un auteur de contenu peut configurer les propriétés du PWA comme onglet supplémentaire dans les [propriétés de page](/help/sites-cloud/authoring/fundamentals/page-properties.md) d’un site.
...
1. Sélectionnez votre projet de sites et sélectionnez [**Propriétés**](/help/sites-cloud/authoring/fundamentals/page-properties.md) ou utilisez la touche de raccourci `p`.
