...
>[!TIP]
>
>Plusieurs raccourcis clavier sont disponibles dans AEM. En particulier lorsque [vous utilisez la console Sites](/help/sites-cloud/authoring/sites-console/keyboard-shortcuts.md) et [l’éditeur de page](/help/sites-cloud/authoring/page-editor/keyboard-shortcuts.md).
...
| Générer des variations | [Générer des variations](/help/generative-ai/generate-variations.md) utilise l’intelligence artificielle générative (IA) pour créer des variations de contenu basées sur des invites ; ces invites sont fournies par Adobe ou créées et gérées par les utilisateurs. |

## Panneau Outils {#tools-panel}

Le panneau **Outils** comporte un panneau latéral contenant une plage de catégories qui regroupent des consoles similaires. Les consoles **Outils** permettent d’accéder à plusieurs outils et consoles spécialisés pour la gestion des sites web, des ressources numériques et d’autres aspects du référentiel de contenu.
...
* [Solutions](https://www.adobe.com/fr/experience-cloud.html) - Sélectionnez cette option pour accéder à vos autres solutions d’Adobe.
...
* [Propriétés de l’utilisateur](/help/sites-cloud/authoring/account-environment.md) - Sélectionnez cette option pour modifier les paramètres de l’utilisateur.
...
* **Console** - La première fois que vous naviguez sur le système, [une série de diapositives présente AEM navigation](#product-navigation).
...
* **Console Outils** - À partir de la console **Outils**, vous pouvez également accéder aux **Ressources** externes :
