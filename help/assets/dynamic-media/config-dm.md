...
1. Si la connexion est établie, vous pouvez définir les éléments suivants :
   ...
   |---|---|
   | Entreprise | Nom du compte Dynamic Media. Vous pouvez avoir un compte Dynamic Media dans Experience Manager.<!-- CQDOC-19579 and CQDOC-19612 --><br>Consultez également [Configurer un compte d’alias de société Dynamic Media](/help/assets/dynamic-media/dm-alias-account.md). |
