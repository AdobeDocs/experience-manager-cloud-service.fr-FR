...
![Résultats de l’optimisation du contenu](/help/ai-in-aem/agents/content-advisor/assets/download-content-optimization.png)
...
## Limites {#limitations-content-optimization}

* La définition de la couleur de fond n’est pas prise en charge.
