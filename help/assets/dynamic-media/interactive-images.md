...
Si vous utilisez Experience Manager Assets et Dynamic Media en mode autonome, copiez le code intégré sur votre site web. Ensuite, intégrez-le à votre aperçu rapide existant. Voir [Intégration d’une image interactive à votre site web](#integrating-an-interactive-image-with-your-website).
