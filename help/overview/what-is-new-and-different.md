...
>[!NOTE]
>
>Pour plus d’informations, voir [Architecture](/help/overview/architecture.md).
...
>[!NOTE]
>
>Pour plus d’informations, commencez par les sections [Restauration de contenu](/help/operations/restore.md), [Indexation](/help/operations/indexing.md) et [Autres tâches de maintenance](/help/operations/maintenance.md).
...
>[!NOTE]
>
>Pour plus de détails, la section [Manipulation de base](/help/sites-cloud/authoring/basic-handling.md) est un bon point de départ.
