...
Les pipelines de configuration peuvent également être déployés via Cloud Manager pour les projets **Edge Delivery**. Utilisez un [**pipeline**](/help/implementing/cloud-manager/configuring-pipelines/configuring-edge-delivery-pipeline.md) lorsque le domaine est joint à un **site Edge Delivery**.
...
Pour les configurations liées au réseau CDN, en plus de l’article lié dans le tableau, consultez également l’article [Fragments de code de configuration CDN pour les scénarios courants](/help/implementing/dispatcher/cdn-configuration-snippets-common-scenarios.md).
...
Pour plus d’informations sur la création et la configuration des pipelines de configuration ****, consultez l’article [Ajouter un pipeline Edge Delivery](/help/implementing/cloud-manager/configuring-pipelines/configuring-edge-delivery-pipeline.md).
...
Pour plus d’informations sur l’utilisation des variables d’environnement, voir [Variables d’environnement ](/help/implementing/cloud-manager/environment-variables.md).
