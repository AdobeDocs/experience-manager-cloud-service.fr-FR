...
* Le service Preview est déployé de manière progressive dans tous les programmes. Les clients sont avertis dans le produit lorsque leur programme est activé pour le service de prévisualisation. Pour plus d’informations, voir [Accès au service de prévisualisation](/help/implementing/cloud-manager/manage-environments.md#access-preview-service).
...
* Pour éviter toute confusion, les lignes de segment de l’instance de publication AEM et de l’instance de publication de Dispatcher sur la page Détails de l’environnement ont été consolidées.
  ...
  ![Publier le Dispatcher](/help/implementing/cloud-manager/release-notes/assets/aem-dispatcher.png)
