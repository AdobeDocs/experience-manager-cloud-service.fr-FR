   ...
   + Formulaires adaptatifs {#adaptive-forms-authoring}
      ...
      + Composants principaux {#authoring-adaptive-forms-core-components}
         + Créer un formulaire adaptatif {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Balises de balisage HTML prises en charge dans le document d’enregistrement](/help/forms/html-markup-tags-support-in-document-of-record.md)
...
+ Communication interactive {#interactive-communication}
   ...
   + Associer l’interface utilisateur {#associateui}
      ...
      + [Générer des communications personnalisées avec l’interface utilisateur associée](/help/forms/interactive-communication/invoke-associate-ui.md)
