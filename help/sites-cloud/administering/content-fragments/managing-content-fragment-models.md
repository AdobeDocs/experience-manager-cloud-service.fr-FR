...
![Console Fragments de contenu - Gestion des modèles de fragment de contenu](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models.png)
...
![Console Fragments de contenu - Informations sur un modèle de fragment de contenu sélectionné](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-selected.png)
...
![Console Fragments de contenu - Configuration des colonnes](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-column-selection.png)
...
![Console Fragments de contenu - Filtrage des modèles de fragment de contenu](/help/sites-cloud/administering/content-fragments/assets/cf-managing-content-fragment-models-filter.png)
...
1. Ouvrez l’onglet **Politiques** pour configurer les éléments suivants :
   ...
   * **Modèles de fragments de contenu autorisés par balise**
   ...
   ![Politique de modèle de fragment de contenu](/help/sites-cloud/administering/content-fragments/assets/cf-cfmodels-policy-assets-folder.png)
...
* Éditeur de modèles
   ...
   * Si vous sélectionnez **Modifier**, vous pouvez modifier et enregistrer vos mises à jour :
     ...
     ![Modifier – Modèle de fragment de contenu verrouillé](/help/sites-cloud/administering/content-fragments/assets/cf-cfmodels-editor-locked-edit.png)
