...
>title="Tests fonctionnels"
>abstract="Découvrez les trois différents types de tests fonctionnels intégrés au processus de déploiement AEM as a Cloud Service. Les tests garantissent la qualité et la fiabilité de votre code."

Découvrez les points de contrôle qualité disponibles dans le processus de déploiement [d’](/help/implementing/cloud-manager/deploy-code.md) ainsi que les différents types de tests fonctionnels intégrés. Découvrez comment contribuer et optimiser leur utilisation dans le cadre d’une stratégie de test complète.
...
### Résumé des points de contrôle qualité fournis par le client
...
| **Validation interne d’** | Oui<br/>blocage<br/> | Délai <br/> blocage <br/> 60 millions | Délai d<br/>expiration de blocage <br/> 30 millions | Non | Non |
...
Ce point de contrôle qualité est préconfiguré et exécute une analyse de code statique sur le code de votre application AEM.
