...
Lors de la modification d’un champ de texte multiligne, vous pouvez ouvrir l’éditeur plein écran ; appuyez ou cliquez dans le texte réel, puis sélectionnez l’icône d’action suivante :
