...
1. [Modification statique des composants](#edit-in-place) qui existent déjà sur la page.
...
Vous pouvez faire glisser de nouveaux composants sur votre page en les sélectionnant dans l’onglet [explorateur de composants dans le panneau latéral](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#components-browser) et les déposer dans un espace réservé de composant.
...
* When [déplacement d’un composant existant,](#movging-components) il apparaîtra comme un carré bleu.
...
Vous pouvez ajouter un nouveau composant à l’aide de l’[explorateur de composants](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#components-browser). La variable [espace réservé du composant](#component-placeholder) vous indique où vous positionnez le composant.

1. Assurez-vous que l’éditeur de page se trouve dans [**Modifier** mode .](/help/sites-cloud/authoring/page-editor/introduction.md#mode-selector)
1. Ouvrez le [navigateur de composants.](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#components-browser)
1. Faites glisser le composant requis vers la [position requise](#component-placeholder) et .
...
Vous pouvez ajouter un nouveau composant à l’aide de l’option **Faire glisser des composants ici** espace réservé du système de paragraphes :
...
1. La variable **Insérer un nouveau composant** s’ouvre pour vous permettre de sélectionner le composant requis. Appuyez ou cliquez sur le composant que vous souhaitez ajouter.
...
Vous pouvez également ajouter un nouveau composant à la page en faisant glisser une ressource depuis l’ [navigateur de ressources.](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#assets-browser) Cela crée automatiquement un composant du type approprié (et contenant la ressource).

Ce comportement peut être configuré pour votre installation. Consultez le document [Guide de référence des composants](/help/implementing/developing/components/reference.md#component-placeholders) pour plus de détails.

Pour créer un composant en faisant glisser l’un des types de ressources ci-dessus, suivez ces étapes :

1. Assurez-vous que votre page se trouve dans [**Modifier** mode .](/help/sites-cloud/authoring/page-editor/introduction.md#mode-selector)
...
* **Insérer le composant** ouvre la boîte de dialogue pour [ajoutez un nouveau composant.](#adding-a-component-from-the-paragraph-system)

  ![Bouton Insérer](assets/edit-content-insert-component.png)

* **Coller** colle le composant du Presse-papiers sur la page. Si l’original reste ou non, selon que vous avez utilisé **Copier** ou **Couper**.
...
* **Groupe** vous permet de sélectionner plusieurs composants à la fois. Vous pouvez obtenir le même résultat sur un ordinateur de bureau à l’aide des commandes **Ctrl-clic** ou **Commande-clic**.
...
* **Disposition** permet de modifier la variable [layout](#editing-component-layout) du composant sélectionné.
...
* **Convertir en variation de fragment d’expérience** permet de créer une [fragment d’expérience](/help/sites-cloud/authoring/fragments/content-fragments.md) du composant sélectionné ou ajoutez-le à un fragment d’expérience existant.
...
![Composant d’image en plein écran](assets/edit-content-image-component-full-screen.png)

Utilisez la variable **Réduire** pour qu’il existe en mode plein écran.
...
1. Dans **Modifier** dans la console sites, sélectionnez un composant pour afficher la barre d’outils du composant.

1. Sélectionnez la variable **Disposition** pour ajuster la mise en page du composant.

   ![Bouton Disposition de la barre d’outils d’un composant](assets/edit-content-layout.png)

1. Une fois l’action Disposition sélectionnée, vous pouvez modifier la mise en page du composant comme vous le feriez dans la section [mode de mise en page.](/help/sites-cloud/authoring/page-editor/responsive-layout.md#defining-layouts-layout-mode)
...
1. Après avoir apporté les modifications nécessaires à la mise en page, appuyez ou cliquez sur le bouton **Fermer** dans le menu action du composant pour arrêter la modification de la mise en page du composant et la barre d’outils du composant revient à son état d’édition normal.
