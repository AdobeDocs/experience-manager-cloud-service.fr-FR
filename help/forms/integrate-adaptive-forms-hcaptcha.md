---
title: Comment utiliser hCaptcha&reg; dans un composant de base de formulaire adaptatif AEM ?
...
AEM Forms as a Cloud Service prend en charge hCaptcha® dans Adaptive Forms. Vous pouvez l’utiliser pour présenter un widget Captcha avec une case à cocher lors de l’envoi d’un formulaire.
...
## Utiliser hCaptcha® dans un formulaire adaptatif{#using-hCaptcha&reg;-foundation-components}
