...
### Exemple de requête API {#sample-request}
...
* Si vous avez uniquement besoin d’effacer le cache de la mémoire interne d’AEM (la réponse graphql), vous devez suivre [cette référence](https://github.com/adobe/aem-cif-guides-venia/blob/main/core/src/main/java/com/venia/core/models/commerce/services/cacheinvalidation/CustomInvalidation.java).
