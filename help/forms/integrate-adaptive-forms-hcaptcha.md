...
AEM Forms as a Cloud Service prend en charge Captcha® dans Adaptive Forms. Vous pouvez l’utiliser pour présenter un défi de widget de case à cocher lors de l’envoi du formulaire.
