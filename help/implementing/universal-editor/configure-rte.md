...
>[!NOTE]
>
>Lorsque vous démarrez un projet d’éditeur universel, toutes les fonctionnalités de texte enrichi prises en charge par votre serveur principal (mise en œuvre d’AEM avec Edge Delivery ou découplée) sont automatiquement actives et disponibles dans [la fenêtre de l’éditeur modal de l’éditeur de texte enrichi](/help/sites-cloud/authoring/universal-editor/authoring.md#modal-editor).
>
