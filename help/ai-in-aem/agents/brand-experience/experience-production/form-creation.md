---
title: Tâche de création de formulaire
description: Découvrez la tâche de création de formulaires de Brand Experience Agent et comment utiliser le langage naturel pour créer des formulaires à partir de zéro.
...
* **Développement accéléré des formulaires** : créez rapidement des formulaires à l’aide de commandes en langage naturel simples, en éliminant la nécessité d’apprendre les interfaces de produit traditionnelles.
...
Après avoir créé votre structure de formulaire initiale à l’aide de l’assistant AI, vous pouvez utiliser le créateur d’expérience Forms pour :
