...
1. Ouvrez le schéma de métadonnées appliqué à vos ressources vidéo, puis cliquez sur **[!UICONTROL Modifier]**.
1. Dans l’éditeur de schéma de métadonnées, sélectionnez l’onglet **[!UICONTROL Vidéo]**.
1. Dans la section **[!UICONTROL Créer un formulaire]**, faites glisser le composant **[!UICONTROL Liste déroulante]** vers le formulaire.
...
1. Sélectionnez le champ nouvellement ajouté et configurez les éléments suivants dans le panneau **[!UICONTROL Paramètres]** :

   * **Libellé du champ** : indiquez un libellé de champ de votre choix.
   * **Associer à la propriété** : `./jcr:content/dam:applyVideoSmartCrop`

1. Dans la section **[!UICONTROL Choix]**, ajoutez les valeurs suivantes :
...
>[!NOTE]
>
>Si le schéma de métadonnées `dm_video` est utilisé dans votre environnement, assurez-vous que la même configuration est également appliquée au schéma de `dm_video`. Cela garantit un comportement cohérent des recadrages intelligents vidéo pour tous les types de schéma vidéo.
...
1. Dans le panneau des métadonnées, définissez **[!UICONTROL Créer un recadrage intelligent de vidéo]** sur **Oui**, mettez à jour le statut de la ressource sur **[!UICONTROL Approuvé]**, puis cliquez sur **[!UICONTROL Enregistrer]**.
