...
>[!IMPORTANT]
>
>Vous pouvez également définir des règles de contrôle d’accès basées sur les attributs à l’aide de l’[agent de gouvernance &#x200B;](/help/ai-in-aem/agents/governance/overview.md#permission-management-in-content-hub).
...
## Questions fréquentes {#faqs-attribute-based-access-control-content-hub}
