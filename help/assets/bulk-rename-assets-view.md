---
title: Renommer et renommer en bloc des ressources dans  [!DNL Assets view]
description: Découvrez comment renommer des ressources en bloc à l’aide de la nouvelle interface utilisateur d’Assets (vue Assets). Elle permet de renommer plusieurs ressources à la fois.
role: User
...
1. [Facultatif] Cliquez sur l’![icône d’annulation](assets/do-not-localize/undo.svg) pour annuler la dernière action que vous avez effectuée.

1. Vérifiez vos modifications dans la colonne [!UICONTROL Aperçu du nouveau nom] et cliquez sur **[!UICONTROL Enregistrer]**.

   ![Renommage en bloc par l’IA](assets/ai-bulk-rename.png)
