...
Ils sont implémentés à l’aide de JUnit et exécutés avec Maven. Voir [Module principal de l’archétype de projet AEM](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/core.html#unit-tests) pour un exemple de test unitaire pour AEM et prise en main.
...
Voir [tests de produits Open Source](https://github.com/adobe/aem-test-samples/tree/aem-cloud/smoke) ou le [Module it.tests de l’archétype des projets AEM](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/ittests.html) pour obtenir des exemples.
...
Voir [exemples de tests open-source](https://github.com/adobe/aem-test-samples/tree/aem-cloud/) ou le [Module ui.tests de l’archétype des projets AEM](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uitests.html) pour obtenir des exemples.
