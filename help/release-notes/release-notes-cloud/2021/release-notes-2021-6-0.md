...
>[!NOTE]
>Consultez le [Guide d’AEM Screens as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/screens-as-cloud-service/home.html?lang=fr) pour obtenir les connaissances de base requises pour réussir l’installation, la configuration et l’exécution de Screens en tant que Cloud Service et reportez-vous à la documentation technique des concepts détaillés.
