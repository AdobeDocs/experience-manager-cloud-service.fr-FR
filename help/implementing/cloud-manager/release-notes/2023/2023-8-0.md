...
* Lorsqu’un certificat expire, les noms de domaine et les listes autorisées d’adresses IP associées au certificat ne sont plus supprimés du réseau de diffusion de contenu.
   ...
   * [L’interface utilisateur de Cloud Manager](/help/implementing/cloud-manager/managing-ssl-certifications/introduction.md) fournira des avertissements avancés plus visibles que le certificat SSL est sur le point d’expirer.
