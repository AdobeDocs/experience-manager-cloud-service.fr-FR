...
La nouvelle version d’aem-sdk-api contient des classes compilées avec une cible Java 11, qui n’est pas compatible avec le JDK par défaut de l’environnement de création Cloud Manager version 1.8. Cette mise à jour nécessite l’exécution de Maven à l’aide du JDK 11.
...
| Composants principaux AEM | Version 2.24.4 | [Composants principaux de la gestion de contenu web d’AEM](https://github.com/adobe/aem-core-wcm-components) |
...
L’activation des fonctionnalités de la version 2024.3.0 fournit l’ensemble des fonctionnalités de cette version de maintenance. Consultez [Feuille de route des versions d’Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html?lang=fr) pour plus d’informations.
...
* SITES-19316 - MSM - Live Copies - Le lien de référence vers le fragment d’expérience ne se met pas à jour dans la copie linguistique.
...
* ASSETS-26842 : mise à jour du texte « Firefly » pour qu’il affiche « App Builder » dans le profil de traitement.
...
* ASSETS-31097 : désactivation de la copie asynchrone pour le contenu de gestion de contenu web afin d’éviter les avertissements de requête de traversée.
