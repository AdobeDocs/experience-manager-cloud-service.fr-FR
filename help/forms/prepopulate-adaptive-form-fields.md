...
* Pour les formulaires adaptatifs utilisant le [modèle de formulaire XFA](prepopulate-adaptive-form-fields.md), utilisez le code XML de préremplissage conforme au schéma de données du modèle XFA.
...
* [Téléchargement du  [!DNL AEM Forms] SDK client](https://helpx.adobe.com/fr/aem-forms/kb/aem-forms-releases.html)
