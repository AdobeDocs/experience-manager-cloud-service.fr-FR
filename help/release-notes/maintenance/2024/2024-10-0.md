...
* ASSETS-41896 : la propriété Assets mentionnée dans cq:discarded sur le dossier NE doit PAS être publiée sur Brand Portal.
...
| Composants principaux AEM | 2.27.0 | [Composants principaux de la gestion de contenu web d’AEM](https://github.com/adobe/aem-core-wcm-components) |
...
* GUIDES-19069 : ajout de guidesPeerLinkIndex pour le module complémentaire de guides AEM.
...
* CNTBF-298 : supprimer jcr:uuid des packages exportés en CC.
...
* GUIDES-17793 : le PDF référencé n’est pas activé à partir du **Tableau de bord de publication en bloc** lors de l’activation en bloc du contenu publié.
...
* SITES - 24091 : partage du module de contenu MSM : master.
...
* SITES - 23585 : problème de restauration de l’héritage pour les composants dotés du nœud cq:responsive
