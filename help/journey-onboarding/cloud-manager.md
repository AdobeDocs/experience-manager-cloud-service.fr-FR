...
Dans l’article précédent du présent parcours d’intégration, [Affectation de membres d’équipe à des profils de produit Cloud Manager](assign-profiles-cloud-manager.md), vous avez attribué les rôles appropriés à votre équipe AEMaaCS. Maintenant, découvrez comment accéder à Cloud Manager afin de pouvoir configurer les ressources de votre projet que votre équipe a l’intention d’utiliser.

Puisque vous avez terminé l’étape précédente dans ce parcours, votre équipe peut accéder à Cloud Manager. Cloud Manager permet de créer et de gérer les ressources de votre projet, telles que les programmes et les environnements.
...
Avant que les membres de l’équipe que vous avez affectés au rôle **Propriétaire de l’entreprise** puissent accéder à Cloud Manager et commencer à créer des ressources cloud, l’administrateur système doit se voir affecter le rôle **Propriétaire de l’entreprise**. Ils doivent également se connecter à Cloud Manager comme vous l’avez fait à l’étape précédente de ce parcours d’intégration.
...
1. Assurez-vous, en tant qu’administrateur ou administratrice système, que le rôle de **Propriétaire de l’entreprise** vous est affecté(e).
   ...
   Revenez à l’étape précédente, [Affecter des membres de l’équipe à des profils de produit Cloud Manager](assign-profiles-cloud-manager.md), pour plus d’informations sur l’attribution du rôle **Propriétaire de l’entreprise** à l’administrateur ou l’administratrice système.

1. Connectez-vous à Cloud Manager sur [my.cloudmanager.adobe.com](https://my.cloudmanager.adobe.com/).

En vous connectant correctement en tant qu’administrateur système avec le rôle **Propriétaire de l’entreprise**, vous initialisez Cloud Manager pour une utilisation par les autres utilisateurs qui disposent du rôle **Propriétaire de l’entreprise**. Vous ne recevez aucune confirmation ni aucun message. Il vous suffit de vous connecter.

Jusqu’à ce que vous vous connectiez à Cloud Manager en tant qu’administrateur système avec le rôle **Propriétaire de l’entreprise**, les autres utilisateurs affectés au rôle **Propriétaire de l’entreprise** ne pourront pas créer de programmes dans Cloud Manager. Cette règle est vraie, même si les rôles appropriés leur sont attribués.
...
Vous pouvez également accéder à la page Cloud Manager **Programmes et produits** à partir de la page d’accueil de Adobe Experience Cloud en procédant comme suit.
...
Si des programmes existent déjà dans votre organisation et que vous êtes administrateur ou administratrice système, votre page de destination affiche le bouton **Gérer l’accès** avec l’option **Ajouter un programme**.
