...
Dans Cloud Manager, chaque compilation peut produire un certain nombre de packages de contenu. Pour diverses raisons, il peut être préférable de produire un package de contenu, mais de ne pas le déployer, Par exemple, lors de la création de packages de contenu utilisés uniquement à des fins de test ou qui sont recompressés par une autre étape du processus de création. C&#39;est-à-dire un sous-package d&#39;un autre package.
