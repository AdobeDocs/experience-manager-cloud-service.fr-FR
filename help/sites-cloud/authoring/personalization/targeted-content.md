...
1. Dans la barre d’outils située en haut de la page, sélectionnez le menu déroulant Mode pour afficher les types de mode disponibles.
...
1. Pour afficher les commandes qui vous guident tout au long du processus de ciblage, sélectionnez **Commencer le ciblage**.
...
1. Sélectionnez un autre emplacement sur l’écran pour enregistrer les modifications.
...
1. Par défaut, aucun identifiant d’emplacement n’est défini. Sélectionnez la roue dentée de configuration pour définir l’emplacement.
...
1. Sélectionnez l’offre pour afficher le menu de l’offre, puis sélectionnez l’icône Modifier .
...
1. Sélectionnez l’offre dans la bibliothèque, puis sélectionnez l’icône en forme de coche.
   ...
   * Sélectionnez **Filtrer** pour filtrer les offres par rapport aux mots-clés ou aux balises. Vous saisissez des mots-clés et sélectionnez des balises dans le menu déroulant. Sélectionnez à nouveau **Filtrer** pour fermer le volet de filtrage.
   ...
   * Modifiez la façon dont vous triez les offres en cliquant ou en appuyant sur la flèche en regard de **Du plus récent au plus ancien**. Les offres peuvent être triées de la plus récente à la plus ancienne et inversement.
   ...
   Sélectionnez l’icône en regard de **Afficher sous** pour afficher les offres sous forme de mosaïque ou de liste.
...
1. Sélectionnez l’offre personnalisée pour afficher le menu de l’offre, puis sélectionnez l’icône **Enregistrer l’offre dans la bibliothèque des offres**.
...
1. Si vous souhaitez mieux contrôler le comptage des mesures de succès, sélectionnez **Paramètres avancés** pour y accéder.
...
1. Pour passer en mode Aperçu, sélectionnez **Aperçu** dans la barre d’outils.
...
1. Une fois le composant ciblé, dans le composant Cible , sélectionnez le composant, puis l’icône des paramètres (engrenage).
...
1. Pour accéder à ces paramètres en mode Plein écran, vous pouvez également sélectionner l’icône Plein écran dans la fenêtre Options du composant cible.
