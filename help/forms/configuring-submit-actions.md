...
# Action Envoyer pour le Forms adaptatif en fonction des composants de base
...
Le [composant Forms adaptatif basé sur les bases](/help/forms/creating-adaptive-form.md) prend en charge diverses [actions d’envoi prêtes à l’emploi](#submit-actions-supported-by-adaptive-forms-based-on-foundation-components). Une action Envoyer est déclenchée lorsqu’un utilisateur ou une utilisatrice clique sur le bouton **[!UICONTROL Envoyer]** d’un formulaire adaptatif.

## Actions Envoyer pour Forms en fonction des composants de base

Les actions Envoyer suivantes sont prises en charge par le Forms adaptatif en fonction des composants de base :
...
Vous pouvez également envoyer un formulaire adaptatif basé sur les composants de base à d’autres configurations de stockage :
...
De plus, vous pouvez [personnaliser les actions Envoyer par défaut](/help/forms/custom-submit-action-form.md) pour vous aligner sur les exigences spécifiques de l’entreprise.

### Configuration d’une action Envoyer pour le formulaire en fonction des composants de base
...
![Action d’envoi AEM Forms](/help/forms/assets/submit-form-foundation-component.png)
