...
description: Avec une conception adaptée, les mêmes expériences peuvent être affichées efficacement sur plusieurs périphériques avec plusieurs orientations.
...
![Exemples de conception adaptée](assets/responsive-example.png)

Développement d&#39;applications Adobe Experience Manager (AEM) qui génèrent du code HTML5 qui s&#39;adapte à plusieurs tailles et orientations de fenêtre. À titre d’exemple, les plages de largeurs de fenêtre d’affichage suivantes correspondent à divers types d’appareil et à diverses orientations :
...
* Les modèles résident en dessous `/apps/<application_name>/templates`
...
* Dans le fichier css.txt du dossier Bibliothèque cliente, commandez les fichiers CSS de liste comme requis dans le fichier CSS assemblé.

The [WKND tutorial](develop-wknd-tutorial.md) uses this strategy to define styles in the site design. Le fichier CSS utilisé par WKND se trouve à l’emplacement `/apps/wknd/clientlibs/clientlib-grid/less/grid.less`.
