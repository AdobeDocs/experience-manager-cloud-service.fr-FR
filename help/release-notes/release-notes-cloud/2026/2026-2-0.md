---
title: Notes de mise à jour de la version 2026.2.0 d’ [!DNL Adobe Experience Manager] as a Cloud Service.
description: Notes de mise à jour de la version 2026.2.0 d’ [!DNL Adobe Experience Manager] as a Cloud Service.
...
# Notes de mise à jour 2026.2.0 pour [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

La section ci-dessous présente les notes de mise à jour techniques de la version 2026.2.0 d’[!DNL Experience Manager] as a Cloud Service.
...
La date de publication de la version actuelle (2026.2.0) de [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] est le 3 mars 2026. La prochaine version des fonctionnalités (2026.3.0) est prévue pour le 26 mars 2026.
...
Regardez la vidéo Aperçu de la version de février 2026 pour un résumé des fonctionnalités ajoutées dans la version 2026.2.0 :
...
Envoyer un courrier électronique à l’adresse [&#128279;](mailto:aem-devagent@adobe.com) pour plus d’informations.
