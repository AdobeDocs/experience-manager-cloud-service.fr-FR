...
Pour configurer le service `UrlProvider` en fonction des exigences et des besoins de SEO, un projet doit fournir une configuration OSGi pour la configuration du fournisseur d’URL _CIF_.
...
#### Utilisez un format d’URL de page produit contenant le SKU. {#use-sku}
...
#### Utilisez un format d’URL de page produit qui contient le contexte de la catégorie. {#use-url}
...
#### Équilibre entre la longueur de l’URL et les informations codées. {#balance-url}
