...
Pour établir une communication entre les [!DNL Experience Manager] et [!DNL Adobe Stock], créez une configuration IMS et une [!DNL Adobe Stock] configuration dans [!DNL Experience Manager].
