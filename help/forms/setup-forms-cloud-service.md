...
description: Découvrez comment installer et configurer un environnement  [!DNL AEM Forms] as a Cloud Service.
...
* **Développeur Forms** : un développeur Forms développe une solution de formulaires personnalisés. Un développeur ou une développeuse Forms entreprend généralement le développement back-end, tel que le développement de composants personnalisés, de workflows AEM, de services de préremplissage, etc.
...
* **Utilisateur final** : il interagit avec le formulaire publié et l’envoie, signe les formulaires envoyés, suit les demandes envoyées via un portail web et reçoit des communications personnalisées.
...
1. Ouvrez l’option Modifier le programme et accédez à l’onglet Solutions et modules complémentaires :
   ...
   * Si vous disposez d’un environnement de production, sélectionnez l’option **[!UICONTROL Forms - Communications]** pour activer Forms - Inscription numérique et Forms - Module complémentaire Communications.
   ...
   * Si vous disposez d’un environnement sandbox, sélectionnez **[!UICONTROL Forms]** pour activer Forms - Inscription numérique et Forms - Module complémentaire Communications.

     ![Sélection de l’inscription numérique au formulaire](assets/forms-digital-enrollment1.png)


1. Cliquez sur **[!UICONTROL Mettre à jour]**.
1. Exécutez le pipeline de build. Une fois que le pipeline de build a réussi, la solution sélectionnée est activée pour votre environnement.
