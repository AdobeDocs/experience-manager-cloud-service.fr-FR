...
En arrière-plan, la fonctionnalité utilise le framework d’intelligence artificielle d’[Adobe AI](https://business.adobe.com/ai/adobe-genai.html) applique automatiquement les balises intelligentes aux ressources chargées, par défaut, avec le texte aligné sur la taxonomie métier.
