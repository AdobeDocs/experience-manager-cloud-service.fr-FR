...
### Nouvelles fonctionnalités de la version préliminaire de [!DNL Sites] {#prerelease-features-sites}
...
* La gestion des images CMJN a été améliorée dans Asset Compute, ce qui permet de générer des balises intelligentes et un recadrage intelligents pour les images CMJN.
