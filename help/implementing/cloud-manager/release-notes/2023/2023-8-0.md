...
La date de publication de la version 2023.8.0 de Cloud Manager dans AEM as a Cloud Service est le 10 août 2023. La prochaine version est prévue pour le 7 septembre 2023.
...
* Lorsqu’un certificat expire, les noms de domaine et les listes autorisées d’adresses IP associées au certificat ne sont plus supprimés du réseau de diffusion de contenu.
   ...
   * [Interface utilisateur de Cloud Manager](/help/implementing/cloud-manager/managing-ssl-certifications/introduction.md) fournit des avertissements avancés plus visibles indiquant que le certificat SSL est sur le point d’expirer.
