...
<tbody>
  ...
  <tr>
    ...
    <td>Les classes de mise en oeuvre du journal ne sont pas compatibles avec AEM as a Cloud Service.</td>
    <td>7/4/21</td>
    <td>26/08/2021</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Cette API n’est pas prise en charge dans Cloud Service.</td>
    <td>9/30/21</td>
    <td>10/30/21</td>
  </tr>
  <tr>
    <td>org.apache.jackrabbit.vault.util.xml<br>org.apache.jackrabbit.vault.util.xml.serialize</td>
    <td>Les classes Util liées à Apache Xerces sont supprimées dans les versions ultérieures, ce qui entraîne un changement de version majeur. Comme ces outils sont destinés à une utilisation interne dans Filevault, l’API est obsolète de la surface de l’API publique.</td>
    <td>9/1/21</td>
    <td>10/30/21</td>
  </tr>
</tbody>
