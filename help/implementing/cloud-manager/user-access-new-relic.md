...
* Optimisation complète des performances en intégrant des mesures clés issues de la surveillance au niveau de l’infrastructure et de la surveillance des applications (Adobe Experience Manager).
...
Pour un programme nouvellement créé, un sous-compte New Relic One est créé pour vous. Toutefois, pour ingérer des données, vous devez les activer. Cette activation n’est pas automatique. Pour activer votre sous-compte, procédez comme suit.

>[!NOTE]
>
>Pour gérer le sous-compte New Relic One, un utilisateur possédant le rôle **Propriétaire de l’entreprise** doit être connecté.
...
>[!NOTE]
>
>Pour gérer les utilisateurs de New Relic One, un utilisateur doté du rôle **Propriétaire de l’entreprise** ou **Responsable de déploiement** doit être connecté.
...
Une fois les utilisateurs définis, New Relic envoie un e-mail de confirmation à chacun d’eux. Il peut ensuite terminer le processus d’activation et se connecter.
...
Adobe surveille les services de création, de publication et de prévisualisation (le cas échéant) d’AEM as a Cloud Service au moyen du plug-in Java New Relic One. Adobe active la télémétrie et la surveillance personnalisées de New Relic One APM dans les environnements AEM as a Cloud Service de production et hors production.
...
* Les mesures et événements de surveillance complets pour les deux comptes New Relic One sont conservés pendant trois mois.
...
New Relic One est la nouvelle plateforme d’observabilité de New Relic. Elle permet à l’assistance d’Adobe et à vos équipes d’observer, de surveiller et d’afficher les mesures et les événements.
...
L’assistance Adobe surveille AEM as a Cloud Service avec New Relic One et d’autres outils, tandis que vos équipes peuvent continuer à utiliser New Relic pour les services et infrastructures sur site. Ils sont en mesure de visualiser les données provenant à la fois du compte Adobe New Relic One et des comptes New Relic gérés par le client.
