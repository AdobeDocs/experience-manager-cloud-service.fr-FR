...
[!DNL Experience Manager Assets] as a [!DNL Cloud Service] est basé sur [!DNL Adobe Experience Manager] et se compare bien avec la dernière version de [!DNL Experience Manager] 6.5. L’offre [!DNL Cloud Service] dispose d’une architecture et de fonctionnalités ajustées permettant d’être un service natif dans le cloud. Les modifications apportées à l’architecture sous-jacente ne permettent pas à toutes les fonctionnalités d’Experience Manager 6.5 de faire partie du [!DNL Cloud Service].
