   ...
   + Formulaires adaptatifs {#adaptive-forms-authoring}
      ...
      + Composants principaux {#authoring-adaptive-forms-core-components}
         + Création d’un formulaire adaptatif {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Utiliser hCaptcha dans un formulaire adaptatif](/help/forms/integrate-adaptive-forms-hcaptcha-core-components.md)
      ...
      + Composants de base {#authoring-adaptive-forms-foundation-components}
         ...
         + Ajout de composants à un formulaire adaptatif {#add-components-to-an-adaptive-form}
            ...
            + [Utiliser Turnstile dans un formulaire adaptatif](/help/forms/integrate-adaptive-forms-turnstile.md)
...
+ Implémenter {#implementing}
   ...
   + Utiliser Cloud Manager {#using-cloud-manager}
      ...
      + Configurations du réseau CDN {#cdn-configurations}
         ...
         + [Configuration de la validation push](/help/implementing/cloud-manager/cdn-configurations/cdn-setup-push-invalidation.md)
