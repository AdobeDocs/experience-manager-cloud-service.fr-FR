...
1. Sélectionnez la configuration **[!UICONTROL Rail de recherche de la boîte de réception]** et appuyez sur **[!UICONTROL Modifier]**.
...
1. Sélectionnez la configuration **[!UICONTROL Rail de recherche de la boîte de réception]** et appuyez sur **[!UICONTROL Supprimer]**.
...
1. Spécifiez une description facultative pour la Configuration et appuyez sur **[!UICONTROL Terminé]** pour enregistrer les modifications.
...
1. Ouvrez le formulaire [pour configuration](#creating-opening-customized-configuration).
1. Appuyez sur l’onglet **[!UICONTROL Sélectionner le prédicat]** et faites glisser **[!UICONTROL Prédicat de texte]** vers le formulaire.
1. Dans l’onglet **[!UICONTROL Paramètres]**, sélectionnez le nom de la colonne de la boîte de réception sur laquelle baser votre recherche, dans le champ **[!UICONTROL Nom de la colonne]**.
...
1. Ouvrez le formulaire [pour configuration](#creating-opening-customized-configuration).
1. Appuyez sur l’onglet **[!UICONTROL Sélectionner le prédicat]** et faites glisser **[!UICONTROL prédicat d’options de colonne personnalisée]** vers le formulaire.
1. Dans l’onglet **[!UICONTROL Paramètres]**, sélectionnez le nom de la colonne de la boîte de réception sur laquelle baser votre recherche, dans le champ **[!UICONTROL Nom de la colonne]**.
...
1. Dans la section **[!UICONTROL Ajouter des options]** :
   ...
   1. Sélectionnez **[!UICONTROL Chemin d’accès aux options CRX]** pour définir les options à l’aide de chemins de référentiel CRX. Appuyez sur **[!UICONTROL Ajouter des chemins d’accès aux options]** pour ajouter plusieurs chemins. Voici un exemple pour définir les options de filtre `Male` et `Female` :
