...
1. Sélectionnez **Aperçu**. La page s’affiche dans un nouvel onglet.
   ...
   >
   >Si vous rencontrez des problèmes avec un aperçu, vérifiez la variable [Frise chronologique](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline) de la page afin de voir si la page a été déplacée.
...
1. Sélectionner **Comparer avec la version actuelle**. La [comparaison des pages](/help/sites-cloud/authoring/features/page-diff.md) s’ouvre et affiche les différences.
