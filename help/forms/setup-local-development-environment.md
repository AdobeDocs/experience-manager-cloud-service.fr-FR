...
Si vous utilisez un programme basé sur la version 40 ou ultérieure de l’archétype AEM pour AEM Forms as a Cloud Service, les composants principaux sont automatiquement activés pour votre environnement.
