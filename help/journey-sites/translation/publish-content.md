...
Dans le document précédent du parcours de traduction AEM Sites, [Traduire le contenu](configure-connector.md), vous avez appris à utiliser les projets de traduction AEM pour traduire votre contenu. Vous devez maintenant :
