...
Oui, les administrateurs peuvent configurer les champs obligatoires ou facultatifs lors de l’ajout de ressources à AEM Assets Content Hub, tels que le nom de la campagne, les mots-clés et les canaux, en fonction des besoins de l’entreprise. Utilisez l’onglet **Importer** de l’interface utilisateur de configuration pour configurer les champs.
